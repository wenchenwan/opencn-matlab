 ...
 * C/C++ source code generated on  : 15-Jun-2022 16:32:36
 */
...
extern void kin_forward_xyzbc(const double in1[5], double in2[4][3], double MGD[5]);

extern void kin_inverse_xyzbc(const double in1[5], double in2[4][3], double MGI[5]);
