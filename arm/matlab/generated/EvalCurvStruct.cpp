                      ...
                      double r0D[10][3], double r1D[10][3], double r2D[10][3], double r3D[10][3])
{
    ...
    case CurveType_Spline:
        ...
        for (int k{0}; k < 10; k++) {
            ...
            bspline_eval(expl_temp.sp.Bl.handle, expl_temp.sp.CoeffX, &r0Dx[k], &r1Dx[k], &r2Dx[k],
                         &r3Dx[k]);
        ...
        for (int b_k{0}; b_k < 10; b_k++) {
            ...
            bspline_eval(expl_temp.sp.Bl.handle, expl_temp.sp.CoeffY, &r0Dy[b_k], &r1Dy[b_k],
                         &r2Dy[b_k], &r3Dy[b_k]);
            // 'bspline_eval_vec:10' x(k) = xk;
            // 'bspline_eval_vec:11' xd(k) = xdk;
            // 'bspline_eval_vec:12' xdd(k) = xddk;
        ...
        for (int c_k{0}; c_k < 10; c_k++) {
            ...
            bspline_eval(expl_temp.sp.Bl.handle, expl_temp.sp.CoeffZ, &r0Dz[c_k], &r1Dz[c_k],
                         &r2Dz[c_k], &r3Dz[c_k]);
            // 'bspline_eval_vec:10' x(k) = xk;
            // 'bspline_eval_vec:11' xd(k) = xdk;
            // 'bspline_eval_vec:12' xdd(k) = xddk;
