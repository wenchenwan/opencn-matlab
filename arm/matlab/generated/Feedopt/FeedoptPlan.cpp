...
void FeedoptPlan(FeedoptContext *ctx, bool *optimized, CurvStruct *opt_struct)
{
    ...
    static const uint64m_T r15{
        {2U, 0U} // chunks
    };
    static const uint64m_T r21{
        {16U, 0U} // chunks
    };
    ...
    *opt_struct = opt_struct_tmp;
    ...
    case Fopt_GCode: {
        ...
        r18 = r7;
        MultiWordAnd((unsigned int *)&r17.chunks[0U], (unsigned int *)&r7.chunks[0U],
                     (unsigned int *)&r19.chunks[0U]);
        if (uMultiWordNe((unsigned int *)&r19.chunks[0U], (unsigned int *)&r3.chunks[0U])) {
        ...
        if (ctx->q_gcode.isempty()) {
            ...
            MultiWordAnd((unsigned int *)&r20.chunks[0U], (unsigned int *)&r21.chunks[0U],
                         (unsigned int *)&r18.chunks[0U]);
            if (uMultiWordNe((unsigned int *)&r18.chunks[0U], (unsigned int *)&r3.chunks[0U])) {
                // 'IsEnabledDebugLog:7' value = true;
                // 'DebugLog:6' fprintf(1, varargin{:});
    ...
    case Fopt_Check: {
        ...
        r6 = r7;
        MultiWordAnd((unsigned int *)&r4.chunks[0U], (unsigned int *)&r7.chunks[0U],
                     (unsigned int *)&r8.chunks[0U]);
        if (uMultiWordNe((unsigned int *)&r8.chunks[0U], (unsigned int *)&r3.chunks[0U])) {
            // 'IsEnabledDebugLog:7' value = true;
            // 'DebugLog:6' fprintf(1, varargin{:});
        ...
        MultiWordAnd((unsigned int *)&r14.chunks[0U], (unsigned int *)&r15.chunks[0U],
    ...
    case Fopt_Smooth: {
        ...
        if (!ctx->q_compress.isempty()) {
            ...
            r12 = r7;
            MultiWordAnd((unsigned int *)&r10.chunks[0U], (unsigned int *)&r7.chunks[0U],
                         (unsigned int *)&r13.chunks[0U]);
            if (uMultiWordNe((unsigned int *)&r13.chunks[0U], (unsigned int *)&r3.chunks[0U])) {
                // 'IsEnabledDebugLog:7' value = true;
                // 'DebugLog:6' fprintf(1, varargin{:});
                printf("Smoothing...\n");
                fflush(stdout);
            ...
            if (uMultiWordNe((unsigned int *)&r12.chunks[0U], (unsigned int *)&r3.chunks[0U])) {
                // 'IsEnabledDebugLog:7' value = true;
                // 'DebugLog:6' fprintf(1, varargin{:});
                printf("Smoothing...\n");
                fflush(stdout);
    ...
    case Fopt_Split:
        ...
        MultiWordAnd((unsigned int *)&r9.chunks[0U], (unsigned int *)&r7.chunks[0U],
                     (unsigned int *)&r11.chunks[0U]);
        if (uMultiWordNe((unsigned int *)&r11.chunks[0U], (unsigned int *)&r3.chunks[0U])) {
            // 'IsEnabledDebugLog:7' value = true;
            // 'DebugLog:6' fprintf(1, varargin{:});
