...
//                const uint64m_T spline_Bl_handle
//                int spline_Bl_order
                        ...
                        const double CoeffP5[6][3], CurvStruct *CStrct)
{
    ...
    CStrct->theta = 0.0;
    CStrct->pitch = 0.0;
    CStrct->CoeffP5.set_size(3, 6);
    for (int b_i{0}; b_i < 6; b_i++) {
        CStrct->R0[b_i] = R0[b_i];
        CStrct->R1[b_i] = R1[b_i];
        CStrct->CoeffP5[CStrct->CoeffP5.size(0) * b_i] = CoeffP5[b_i][0];
        CStrct->CoeffP5[CStrct->CoeffP5.size(0) * b_i + 1] = CoeffP5[b_i][1];
        CStrct->CoeffP5[CStrct->CoeffP5.size(0) * b_i + 2] = CoeffP5[b_i][2];
    }
    CStrct->sp_index = 1U;
    CStrct->i_begin_sp = 0;
    CStrct->i_end_sp = 0;
