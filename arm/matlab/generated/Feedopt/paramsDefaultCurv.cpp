...
void paramsDefaultCurv(
    ...
    ::coder::array<double, 2U> &params_spline_Bl_breakpoints, uint64m_T *params_spline_Bl_handle,
    int *params_spline_Bl_order, ::coder::array<double, 2U> &params_spline_coeff,
