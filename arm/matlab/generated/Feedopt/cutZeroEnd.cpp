    ...
    *curv2 = *curv;
    ...
    while (searchJps) {
        ...
        if ((r2D.size(1) == r.size(1)) && (c_r1D.size(1) == udd_vec.size(1)) &&
            ...
            for (int i25{0}; i25 < s_loop_ub; i25++) {
                ...
                for (int i27{0}; i27 < u_loop_ub; i27++) {
                    A[i27 + A.size(0) * i25] = r2D[i27 + r2D.size(0) * i25] * r[i25] +
        ...
        for (int i26{0}; i26 < t_loop_ub; i26++) {
            double d_varargin_1;
            d_varargin_1 = ud[i26];
            r[i26] = std::pow(d_varargin_1, 3.0);
        }
        if (r2D.size(1) == 1) {
            i28 = ud.size(1);
        } else {
        ...
        if ((r3D.size(1) == r.size(1)) && (r2D.size(1) == ud.size(1)) && (i28 == udd_vec.size(1)) &&
            (r3D.size(0) == r2D.size(0)) && (i29 == i31) && (c_r1D.size(1) == y.size(1)) &&
            (i32 == c_r1D.size(0)) && (i35 == i36)) {
            int v_loop_ub;
                ...
                for (int i63{0}; i63 < ob_loop_ub; i63++) {
                    ...
                    for (int i64{0}; i64 < pb_loop_ub; i64++) {
                        b_x[i64 + b_x.size(0) * i63] =
                            (r1[i64 + r1.size(0) * i63] > vmax_data[i64]);
                    }
                }
            } else {
                ...
                if (r1.size(0) == b_trueCount) {
                    ...
                    for (int i67{0}; i67 < qb_loop_ub; i67++) {
                        ...
                        for (int i69{0}; i69 < sb_loop_ub; i69++) {
                            r2[i69 + r2.size(0) * i67] =
                                r1[i69 + r1.size(0) * i67] - vmax_data[i69];
                        }
                    }
                    ...
                    for (int i71{0}; i71 < ub_loop_ub; i71++) {
                        int vb_loop_ub;
                        vb_loop_ub = r2.size(0);
                        for (int i72{0}; i72 < vb_loop_ub; i72++) {
                            r1[i72 + r1.size(0) * i71] = r2[i72 + r2.size(0) * i71];
                        }
                    }
                    ...
                    for (int i68{0}; i68 < rb_loop_ub; i68++) {
                        ...
                        for (int i70{0}; i70 < tb_loop_ub; i70++) {
                            b_x[i70 + b_x.size(0) * i68] =
                                (r1[i70 + r1.size(0) * i68] > amax_data[i70]);
                        }
                    }
                } else {
                    ...
                    if (r1.size(0) == c_trueCount) {
                        ...
                        for (int i75{0}; i75 < wb_loop_ub; i75++) {
                            ...
                            for (int i77{0}; i77 < yb_loop_ub; i77++) {
                                r3[i77 + r3.size(0) * i75] =
                                    r1[i77 + r1.size(0) * i75] - amax_data[i77];
                            }
                        }
                        ...
                        for (int i79{0}; i79 < bc_loop_ub; i79++) {
                            ...
                            for (int i80{0}; i80 < cc_loop_ub; i80++) {
                                r1[i80 + r1.size(0) * i79] = r3[i80 + r3.size(0) * i79];
                            }
                        }
                    ...
                    if (r1.size(0) == d_trueCount) {
                        ...
                        for (int i76{0}; i76 < xb_loop_ub; i76++) {
                            ...
                            for (int i78{0}; i78 < ac_loop_ub; i78++) {
                                b_x[i78 + b_x.size(0) * i76] =
                                    (r1[i78 + r1.size(0) * i76] > jmax_data[i78]);
                            }
                        }
                    } else {
                        ...
                        if (r1.size(0) == d_trueCount) {
                            ...
                            for (int i81{0}; i81 < dc_loop_ub; i81++) {
                                ...
                                for (int i82{0}; i82 < ec_loop_ub; i82++) {
                                    r4[i82 + r4.size(0) * i81] =
                                        r1[i82 + r1.size(0) * i81] - jmax_data[i82];
                                }
                            }
                            r1.set_size(r4.size(0), r4.size(1));
                            fc_loop_ub = r4.size(1);
                            for (int i83{0}; i83 < fc_loop_ub; i83++) {
                                int gc_loop_ub;
                                gc_loop_ub = r4.size(0);
                                for (int i84{0}; i84 < gc_loop_ub; i84++) {
                                    r1[i84 + r1.size(0) * i83] = r4[i84 + r4.size(0) * i83];
                                }
                            }
