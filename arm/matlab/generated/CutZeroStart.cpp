                  ...
                  CurvStruct *CurvStruct1, CurvStruct *CurvStruct2)
{
    ...
    if ((r4.size(1) == r5.size(1)) && (i10 == c.size(1))) {
        int j_loop_ub;
        ...
        for (int i11{0}; i11 < 3; i11++) {
            for (int i12{0}; i12 < j_loop_ub; i12++) {
                a[i12 + a.size(0) * i11] =
                    (r4[i11 + 3 * i12] + 3.0 * r5[i11 + 3 * i12]) + c[i11 + 3 * i12];
            }
        }
    } else {
        binary_expand_op(a, r4, r5, c);
    }
    ...
    if (r4.size(1) == r5.size(1)) {
        ...
        for (int i19{0}; i19 < 3; i19++) {
            for (int i21{0}; i21 < n_loop_ub; i21++) {
                a[i21 + a.size(0) * i19] = r4[i19 + 3 * i21] + r5[i19 + 3 * i21];
            }
        }
    } else {
        b_binary_expand_op(a, r4, r5);
    }
    b_x.set_size(a.size(0), 3);
    if (a.size(0) != 0) {
        int c_acoef;
    ...
    coder::b_eml_find(b_norm_vt, (int *)&value_data, value_size);
    if (value_size[1] == 0) {
