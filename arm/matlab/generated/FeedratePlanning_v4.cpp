...
void FeedratePlanning_v4(FeedoptContext *ctx, const ::coder::array<CurvStruct, 2U> &CurvStructs0,
                         ...
                         const ::coder::array<double, 2U> &BasisValD,
                         const ::coder::array<double, 2U> &BasisValDD,
                         const ::coder::array<double, 1U> &BasisIntegr, const uint64m_T Bl_handle,
                         ...
                         ::coder::array<double, 2U> &Coeff, int *NCoeff, bool *success)
{
    ...
    r10 = r2;
    MultiWordAnd((unsigned int *)&r9.chunks[0U], (unsigned int *)&r2.chunks[0U],
    ...
    r12 = r2;
    MultiWordAnd((unsigned int *)&r11.chunks[0U], (unsigned int *)&r2.chunks[0U],
    ...
    r14 = r2;
    MultiWordAnd((unsigned int *)&r13.chunks[0U], (unsigned int *)&r2.chunks[0U],
    ...
    r16 = r2;
    MultiWordAnd((unsigned int *)&r15.chunks[0U], (unsigned int *)&r2.chunks[0U],
    ...
    r18 = r2;
    MultiWordAnd((unsigned int *)&r17.chunks[0U], (unsigned int *)&r2.chunks[0U],
    ...
    if (!b_success) {
        ...
        r24 = r25;
        MultiWordAnd((unsigned int *)&r23.chunks[0U], (unsigned int *)&r25.chunks[0U],
        ...
        r29 = r25;
        MultiWordAnd((unsigned int *)&r27.chunks[0U], (unsigned int *)&r25.chunks[0U],
                     (unsigned int *)&r26.chunks[0U]);
        if (uMultiWordNe((unsigned int *)&r26.chunks[0U], (unsigned int *)&r4.chunks[0U])) {
            // 'IsEnabledDebugLog:7' value = true;
            // 'DebugLog:6' fprintf(1, varargin{:});
            printf("\n");
            fflush(stdout);
        ...
        while ((!c_success) && (max_increase > 0)) {
            ...
            A.vertcat(&A_jerk, &r33);
            c_beq = beq.reshape(beq_idx_0, 1);
            c_simplex(f, &r33, d_b, Aeq, c_beq, Coeff2, &d_success, &b_status);
            c_success = d_success;
        ...
        if (!c_success) {
            ...
            if (uMultiWordNe((unsigned int *)&r29.chunks[0U], (unsigned int *)&r4.chunks[0U])) {
                // 'IsEnabledDebugLog:7' value = true;
                // 'DebugLog:6' fprintf(1, varargin{:});
                printf("Coeff3 = ");
                fflush(stdout);
            ...
            for (int d_k{0}; d_k < i13; d_k++) {
                ...
                // 'IsEnabledDebugLog:4' value = false;
                // 'IsEnabledDebugLog:6' if bitget(DebugConfig, int32(cfg))
                Double2MultiWord(DebugConfig, (unsigned int *)&r35.chunks[0U]);
                MultiWordAnd((unsigned int *)&r35.chunks[0U], (unsigned int *)&r25.chunks[0U],
            ...
            if (uMultiWordNe((unsigned int *)&r32.chunks[0U], (unsigned int *)&r4.chunks[0U])) {
                // 'IsEnabledDebugLog:7' value = true;
                // 'DebugLog:6' fprintf(1, varargin{:});
                printf("\n");
                fflush(stdout);
            ...
            ctx->at_0 = ((r2D[0] * q_val + 0.5 * b_b_idx_0) * (r1D[0] / n_tmp) +
                         (r2D[1] * q_val + 0.5 * b_idx_1) * (r1D[1] / n_tmp)) +
                        (r2D[2] * q_val + 0.5 * b_idx_2) * (r1D[2] / n_tmp);
