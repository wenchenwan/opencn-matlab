                      ...
                      double pitch, const double CoeffP5[6][3], double FeedRate, CurvStruct *CStrct)
{
    ...
    // 'ConstrCurvStruct:60'                 'index_smooth', int32(0),...
    // 'ConstrCurvStruct:61'                 'UseConstJerk', false,...
    // 'ConstrCurvStruct:62'                 'ConstJerk', 0,...
    // 'ConstrCurvStruct:63'                 'ConstJerkMaxIterations', int32(0),...
    // 'ConstrCurvStruct:64'                 'Coeff', zeros(0, 1),...
    // 'ConstrCurvStruct:65'                 'a_param', 1,...
    // 'ConstrCurvStruct:66'                 'b_param', 0,...
    // 'ConstrCurvStruct:67'                 'sp', struct('CoeffX', 0,...
    // 'ConstrCurvStruct:68'                     'CoeffY', 0,...
    // 'ConstrCurvStruct:69'                     'CoeffZ', 0,...
    // 'ConstrCurvStruct:70'                     'Bl', struct(...
    // 'ConstrCurvStruct:71'                         'ncoeff', int32(0),...
    // 'ConstrCurvStruct:72'                         'breakpoints', zeros(1, 0),...
    // 'ConstrCurvStruct:73'                         'handle', uint64(0),...
    // 'ConstrCurvStruct:74'                         'degree', int32(0)),...
    // 'ConstrCurvStruct:75'                     'knots', 0,...
    // 'ConstrCurvStruct:76'                     'Ltot', 0,...
    // 'ConstrCurvStruct:77'                     'Lk', 0));
    CStrct->Type = Type;
    ...
    CStrct->sp.Lk[0] = 0.0;
    // 'ConstrCurvStruct:79' if ~coder.target('matlab')
    // 'ConstrCurvStruct:80' coder.cstructname(CStrct, 'CurvStruct');
    // 'ConstrCurvStruct:81' coder.cstructname(CStrct.sp, 'SplineStruct');
    // 'ConstrCurvStruct:82' coder.cstructname(CStrct.sp.Bl, 'SplineBase');
    // 'ConstrCurvStruct:84' coder.varsize('CStrct.sp.Bl.breakpoints', [1, Inf], [0, 1]);
    // 'ConstrCurvStruct:86' coder.varsize('CStrct.Coeff', [Inf, 1], [1, 0]);
    // 'ConstrCurvStruct:87' coder.varsize('CStrct.sp.CoeffX', [1, Inf], [0, 1]);
    // 'ConstrCurvStruct:88' coder.varsize('CStrct.sp.CoeffY', [1, Inf], [0, 1]);
    // 'ConstrCurvStruct:89' coder.varsize('CStrct.sp.CoeffZ', [1, Inf], [0, 1]);
    // 'ConstrCurvStruct:90' coder.varsize('CStrct.sp.knots',  [1, Inf], [0, 1]);
    // 'ConstrCurvStruct:91' coder.varsize('CStrct.sp.Lk',     [1, Inf], [0, 1]);
    // 'ConstrCurvStruct:93' coder.varsize('CStrct.CoeffP5', [3, 6], [0, 0]);
}
