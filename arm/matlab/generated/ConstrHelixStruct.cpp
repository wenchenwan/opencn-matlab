...
//
namespace ocn {
void ConstrHelixStruct(bool trafo, bool HSC, const double Poff[3], const double Aoff[3],
                       ...
                       ZSpdMode mode, CurvStruct *b_CurvStruct)
{
    ...
    // 'ConstrHelixStruct:8'                                 Poff, Aoff, Uoff, Doff, P0, ...
    // 'ConstrHelixStruct:9'                                 P1, A0, A1, U0, U1, Cprim, delta,
    // evec,... 'ConstrHelixStruct:10'                                 theta, pitch, CoeffP5,
    // FeedRate);
    for (int i{0}; i < 6; i++) {
        dv[i][0] = 0.0;
        dv[i][1] = 0.0;
    ...
    ConstrCurvStruct(CurveType_Helix, mode, trafo, HSC, Poff, Aoff, Uoff, Doff, P0, P1, A0, A1, U0,
                     U1, Cprim, delta, evec, theta, pitch, dv, FeedRate, b_CurvStruct);
