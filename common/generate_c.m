...
P0 = [0,0,0]';
trafo = false; HSC = false; HSC_cmd = char(zeros(1,256));
Doff = 0.0;
...
codegen('-config', cfg,'-d', output_root, '-o', 'opencn_matlab',...
    ...
    'ConstrLineStruct', '-args', {trafo, HSC, HSC_cmd, P0, P0 P0, Doff, P0, P0, P0, P0, P0, P0, 1.0, ZSpdMode.NN},...
    'ConstrHelixStruct', '-args', {trafo, HSC, HSC_cmd, P0, P0 P0, Doff, P0, P0, P0, P0, P0, P0, P0, 1.0, P0, 1.0, 1.0, 1.0, ZSpdMode.NN},...
    'ConstrHelixStructFromArcFeed', '-args', {trafo, HSC, HSC_cmd, P0, P0 P0, Doff, 0,0,0,  0,0,0,  0,0,0,  P0, P0, P0, P0, 0,[0,0,0]'},...
