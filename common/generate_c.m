...
if( generate_all || generate_Feedopt )
    if( ~DEBUG  )
...
[cfg, output_root] = generate_c_config(generate_for_arm_32, generate_for_arm_64, generate_for_x86_64, 0);
output_root = output_root + "/matlab/generated" + "/kinematic";
