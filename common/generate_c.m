...
codegen('-config', cfg,'-d', output_root, ...
    ...
    'ConstrLineStruct', '-args', {trafo, P0, P0, P0, P0, P0, P0, 1.0, ZSpdMode.NN},...
    'ConstrHelixStruct', '-args', {trafo, P0, P0, P0, P0, P0, P0, P0, 1.0, P0, 1.0, 1.0, 1.0, ZSpdMode.NN},...
    'ConstrHelixStructFromArcFeed', '-args', {trafo, 0,0,0,  0,0,0,  0,0,0,  P0, P0, P0, P0, 0,[0,0,0]'},...
    ...
    'EnableDebugLog', '-args', DebugCfg.Warning,...
    'DisableDebugLog', '-args', DebugCfg.Warning,...
