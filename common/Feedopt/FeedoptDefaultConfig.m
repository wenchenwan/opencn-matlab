...
cfg = struct(...
    ...
    'fmax', 1000,...
    'smax', 75000,...
    'vmax', [500,500,500,0, 40,50],... %[mm] [rad]
    'amax', [20000,20000,20000,0, 200,1000],...
    'jmax', [1500000,1500000,1500000,0,10000,50000],...
