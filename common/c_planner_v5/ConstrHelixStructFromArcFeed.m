...
if evec(1) > 0.5        % YZ
    [~, Cprim] = CorrectArcCenter([P0(2), P0(3)]', [P1(2), P1(3)]', [C(2), C(3)]');
...
elseif evec(2) > 0.5    % ZX
    [~, Cprim] = CorrectArcCenter([P0(3), P0(1)]', [P1(3), P1(1)]', [C(3), C(1)]');
    ...
    [~, Cprim] = CorrectArcCenter([P0(1), P0(2)]', [P1(1), P1(2)]', [C(1), C(2)]');
...
CurvStruct = ConstrHelixStruct(P0, P1, Cprim, evec, theta, pitch, 1, ZSpdMode.NN);
