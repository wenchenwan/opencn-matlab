...
Line1 = ConstrLineStruct(trafo, HSC, HSC_cmd, Poff, Aoff, Uoff, ...
...
for k=1:NSegm_G01
    ...
    Line = ConstrLineStruct(trafo, HSC, HSC_cmd, Poff, Aoff, Uoff, ...
                            Doff, P0, P1, A0, A1, U0, U1, 100, ZSpdMode.NN);
    ctx.q_gcode.push(Line);
    
end

Line2 = ConstrLineStruct(trafo, HSC, HSC_cmd, Poff, Aoff, Uoff, ...
                            Doff, P1, [P1(1)+L, 0, 0]', A0, A1, U0, U1, ...
                            100, ZSpdMode.NN);

ctx.q_gcode.push(Line2);

Arc = ConstrHelixStructFromArcFeed(trafo, HSC, HSC_cmd, ...
...
Line3 = ConstrLineStruct(trafo, HSC, HSC_cmd, Poff, Aoff, Uoff, ...
