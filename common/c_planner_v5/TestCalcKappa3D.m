...
Curv1 = ConstrLineStruct(trafo, HSC, HSC_cmd, Poff, Aoff, Uoff, ...
                               Doff, [-1;0;0], [0;0;0], A0, A1, U0, ...
                               U1, vmax, ZSpdMode.NN);

Curv2 = ConstrHelixStruct(trafo, HSC, HSC_cmd, Poff, Aoff, Uoff, Doff,...
                            [0;0;0], [0;1;0], A0, A1, U0, U1, [0;0;1], ...
                            0, [0;0;0], pi, 0, vmax, ZSpdMode.NN);

Curv3 = ConstrLineStruct(trafo, HSC, HSC_cmd, Poff, Aoff, Uoff, ...
