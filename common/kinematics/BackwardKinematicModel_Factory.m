function [r_a] = BackwardKinematicModel_Factory( x, y, z, b, c, mx, my, mz,...
...
BW_RTCP_sym = simplify( Translation( [0, 0, t_l]) * M5_T0M(mx, my, mz+d1) ...
                        * subs(M5_TMC_sym(d1), y, 0) * M5_TCP(px, -p_y, pz) ...
                        * inv(subs(M5_TMC_sym(d1), [b, c], [0, 0])) ...
                        * M5_TMB_sym(d2) * M5_TBO(t_l) ...
