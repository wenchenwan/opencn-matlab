...
//
//  _coder_bspline_base_eval_mex_mex.cpp
//
//  Code generation for function '_coder_bspline_base_eval_mex_mex'
//
...
static const char * emlrtEntryPoints[2] = { "bspline_create",
  "bspline_base_eval" };

// Function Declarations
MEXFUNCTION_LINKAGE void bspline_base_eval_mexFunction(int32_T nlhs, mxArray
...
void bspline_base_eval_mexFunction(int32_T nlhs, mxArray *plhs[5], int32_T nrhs,
  const mxArray *prhs[2])
{
  ...
  // Call the function.
  ocn::bspline_base_eval_api(prhs, nlhs, outputs);
                 ...
                 *prhs[])
{
  ...
  mexAtExit(&bspline_base_eval_mex_atexit);

  // Module initialization.
  ocn::bspline_base_eval_mex_initialize();
  ...
  switch (emlrtGetEntryPointIndexR2016a(&st, nrhs, prhs, emlrtEntryPoints, 2)) {
   ...
   case 1:
    bspline_base_eval_mexFunction(nlhs, plhs, nrhs - 1, *(const mxArray *(*)[2])
      &prhs[1]);
    break;
  }

  // Module termination.
  ocn::bspline_base_eval_mex_terminate();
}
...
// End of code generation (_coder_bspline_base_eval_mex_mex.cpp)
