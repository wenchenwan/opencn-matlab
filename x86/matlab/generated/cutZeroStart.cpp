...
//
namespace ocn {
void cutZeroStart(const queue_coder *ctx_q_splines, const double ctx_cfg_amax[3],
                  ...
                  CurvStruct *CurvStruct1, CurvStruct *CurvStruct2)
{
    ...
    double z1_idx_2;
    bool searchU;
    // 'cutZeroStart:3' [ u, jps ] = zeroSpeedCurv( ctx, CurvStruct, false );
    ...
    while (searchU) {
        ...
        constJerkU(jps, ctx_cfg_dt, false, b_CurvStruct->a_param, b_CurvStruct->b_param, &b_u,
    ...
    // 'cutZeroStart:5' CurvStruct1 = CurvStruct;
    *CurvStruct1 = *b_CurvStruct;
    // 'cutZeroStart:6' CurvStruct1.a_param = u;
    CurvStruct1->a_param = u;
    // 'cutZeroStart:7' CurvStruct1.b_param = 0;
    CurvStruct1->b_param = 0.0;
    // 'cutZeroStart:8' CurvStruct1.UseConstJerk = true;
    CurvStruct1->UseConstJerk = true;
    // 'cutZeroStart:9' CurvStruct1.ConstJerk = jps;
    CurvStruct1->ConstJerk = jps;
    // 'cutZeroStart:10' CurvStruct1.zspdmode = ZSpdMode.ZN;
    CurvStruct1->zspdmode = ZSpdMode_ZN;
    // 'cutZeroStart:11' CurvStruct1.ConstJerkMaxIterations = int32(0);
    CurvStruct1->ConstJerkMaxIterations = 0;
    // 'cutZeroStart:12' CurvStruct1.gcode_source_line = CurvStruct.gcode_source_line;
    CurvStruct1->gcode_source_line = b_CurvStruct->gcode_source_line;
    // 'cutZeroStart:14' CurvStruct2 = CurvStruct1;
    *CurvStruct2 = *CurvStruct1;
    // 'cutZeroStart:15' CurvStruct2.UseConstJerk = false;
    CurvStruct2->UseConstJerk = false;
    // 'cutZeroStart:16' CurvStruct2.b_param = CurvStruct1.a_param + CurvStruct1.b_param;
    CurvStruct2->b_param = u;
    // 'cutZeroStart:17' CurvStruct2.a_param = 1 - CurvStruct2.b_param;
    CurvStruct2->a_param = 1.0 - u;
    // 'cutZeroStart:18' CurvStruct2.zspdmode = ZSpdMode.NN;
    CurvStruct2->zspdmode = ZSpdMode_NN;
    // 'cutZeroStart:20' if( coder.target("MATLAB") )
}
