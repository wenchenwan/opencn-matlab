    ...
    *opt_struct = opt_struct_tmp;
    ...
    case Fopt_GCode: {
        ...
        while (status != 0) {
            ...
            r1 = _mm_loadu_pd(&b_CurvStruct.R0[3]);
            r2 = _mm_set1_pd(0.017453292519943295);
            _mm_storeu_pd(&b_CurvStruct.R0[3], _mm_mul_pd(r2, r1));
            r3 = _mm_loadu_pd(&b_CurvStruct.R1[3]);
            _mm_storeu_pd(&b_CurvStruct.R1[3], _mm_mul_pd(r2, r3));
