                     ...
                     ::coder::array<double, 2U> &udd, double *jps)
{
    ...
    while (searchJps) {
        ...
        if ((r2D.size(1) == r1.size(1)) && (c_r1D.size(1) == udd_vec.size(1)) &&
            ...
            for (int i32{0}; i32 < bb_loop_ub; i32++) {
                ...
                for (i34 = 0; i34 <= l_vectorUB; i34 += 2) {
                    __m128d r12;
                    __m128d r13;
                ...
                for (i34 = l_scalarLB; i34 < db_loop_ub; i34++) {
        ...
        if ((r3D.size(1) == r1.size(1)) && (r2D.size(1) == ud.size(1)) &&
            ...
            for (int i44{0}; i44 < eb_loop_ub; i44++) {
                ...
                for (i45 = 0; i45 <= m_vectorUB; i45 += 2) {
                    __m128d r14;
                    __m128d r15;
                    __m128d r16;
                ...
                for (i45 = m_scalarLB; i45 < fb_loop_ub; i45++) {
                    J[i45 + J.size(0) * i44] =
        ...
        if (y.size(1) == ud.size(1)) {
            ...
            for (i53 = 0; i53 <= n_vectorUB; i53 += 2) {
                __m128d r17;
                __m128d r18;
            ...
            for (i53 = n_scalarLB; i53 < kb_loop_ub; i53++) {
        ...
        if (b_y) {
            ...
            for (i57 = 0; i57 <= o_vectorUB; i57 += 2) {
                __m128d r19;
                r19 = _mm_loadu_pd(&feed[i57]);
                _mm_storeu_pd(&b_feed[i57], _mm_sub_pd(r19, _mm_set1_pd(b_fmax)));
            }
            for (i57 = o_scalarLB; i57 < mb_loop_ub; i57++) {
                b_feed[i57] = feed[i57] - b_fmax;
            }
            ...
            if (c_y) {
                ...
                if (b_z1.size(0) == b_trueCount) {
                    ...
                    for (int i62{0}; i62 < pb_loop_ub; i62++) {
                        ...
                        p_scalarLB = (b_z1.size(0) / 2) << 1;
                        p_vectorUB = p_scalarLB - 2;
                        for (i66 = 0; i66 <= p_vectorUB; i66 += 2) {
                            __m128d r20;
                            __m128d r21;
                            r20 = _mm_loadu_pd(&b_z1[i66 + b_z1.size(0) * i62]);
                            r21 = _mm_loadu_pd(&vmax_data[i66]);
                            _mm_storeu_pd(&c_z1[i66 + c_z1.size(0) * i62], _mm_sub_pd(r20, r21));
                        }
                        for (i66 = p_scalarLB; i66 < rb_loop_ub; i66++) {
                            c_z1[i66 + c_z1.size(0) * i62] =
                                b_z1[i66 + b_z1.size(0) * i62] - vmax_data[i66];
                        }
                    }
                    ...
                    for (int i65{0}; i65 < tb_loop_ub; i65++) {
                        ...
                        for (int i67{0}; i67 < ub_loop_ub; i67++) {
                            b_z1[i67 + b_z1.size(0) * i65] = c_z1[i67 + c_z1.size(0) * i65];
                        }
                    }
                    ...
                    for (int i63{0}; i63 < qb_loop_ub; i63++) {
                        ...
                        for (int i64{0}; i64 < sb_loop_ub; i64++) {
                            b_x[i64 + b_x.size(0) * i63] =
                                (b_z1[i64 + b_z1.size(0) * i63] > amax_data[i64]);
                        }
                    }
                } else {
                ...
                if (d_y) {
                    ...
                    if (b_z1.size(0) == c_trueCount) {
                        ...
                        for (int i70{0}; i70 < vb_loop_ub; i70++) {
                            ...
                            q_scalarLB = (b_z1.size(0) / 2) << 1;
                            q_vectorUB = q_scalarLB - 2;
                            for (i74 = 0; i74 <= q_vectorUB; i74 += 2) {
                                __m128d r22;
                                __m128d r23;
                                r22 = _mm_loadu_pd(&b_z1[i74 + b_z1.size(0) * i70]);
                                r23 = _mm_loadu_pd(&amax_data[i74]);
                                _mm_storeu_pd(&d_z1[i74 + d_z1.size(0) * i70],
                                              _mm_sub_pd(r22, r23));
                            }
                            for (i74 = q_scalarLB; i74 < xb_loop_ub; i74++) {
                                d_z1[i74 + d_z1.size(0) * i70] =
                                    b_z1[i74 + b_z1.size(0) * i70] - amax_data[i74];
                            }
                        }
                        ...
                        for (int i73{0}; i73 < ac_loop_ub; i73++) {
                            ...
                            for (int i75{0}; i75 < bc_loop_ub; i75++) {
                                b_z1[i75 + b_z1.size(0) * i73] = d_z1[i75 + d_z1.size(0) * i73];
                            }
                        }
                    ...
                    if (b_z1.size(0) == d_trueCount) {
                        ...
                        for (int i71{0}; i71 < wb_loop_ub; i71++) {
                            ...
                            for (int i72{0}; i72 < yb_loop_ub; i72++) {
                                b_x[i72 + b_x.size(0) * i71] =
                                    (b_z1[i72 + b_z1.size(0) * i71] > jmax_data[i72]);
                            }
                        }
                    } else {
                    ...
                    if (e_y) {
                        ...
                        if (b_z1.size(0) == d_trueCount) {
                            ...
                            for (int i76{0}; i76 < cc_loop_ub; i76++) {
                                ...
                                r_scalarLB = (b_z1.size(0) / 2) << 1;
                                r_vectorUB = r_scalarLB - 2;
                                for (i78 = 0; i78 <= r_vectorUB; i78 += 2) {
                                    __m128d r24;
                                    __m128d r25;
                                    r24 = _mm_loadu_pd(&b_z1[i78 + b_z1.size(0) * i76]);
                                    r25 = _mm_loadu_pd(&jmax_data[i78]);
                                    _mm_storeu_pd(&e_z1[i78 + e_z1.size(0) * i76],
                                                  _mm_sub_pd(r24, r25));
                                }
                                for (i78 = r_scalarLB; i78 < dc_loop_ub; i78++) {
                                    e_z1[i78 + e_z1.size(0) * i76] =
                                        b_z1[i78 + b_z1.size(0) * i76] - jmax_data[i78];
                                }
                            }
                            b_z1.set_size(e_z1.size(0), e_z1.size(1));
                            ec_loop_ub = e_z1.size(1);
                            for (int i77{0}; i77 < ec_loop_ub; i77++) {
                                int fc_loop_ub;
                                fc_loop_ub = e_z1.size(0);
                                for (int i79{0}; i79 < fc_loop_ub; i79++) {
                                    b_z1[i79 + b_z1.size(0) * i77] = e_z1[i79 + e_z1.size(0) * i77];
                                }
                            }
    ...
    for (i9 = b_scalarLB; i9 < f_loop_ub; i9++) {
    ...
    for (i13 = d_scalarLB; i13 < i_loop_ub; i13++) {
                   ...
                   ::coder::array<double, 2U> &ud, ::coder::array<double, 2U> &udd, double *jps)
{
    ...
    while (searchJps) {
        ...
        for (i8 = b_scalarLB; i8 < e_loop_ub; i8++) {
        ...
        if ((r2D.size(1) == r3.size(1)) && (c_r1D.size(1) == udd_vec.size(1)) &&
            ...
            for (int i30{0}; i30 < y_loop_ub; i30++) {
                ...
                j_vectorUB = j_scalarLB - 2;
                for (i32 = 0; i32 <= j_vectorUB; i32 += 2) {
                    __m128d r10;
                    __m128d r11;
                ...
                for (i32 = j_scalarLB; i32 < bb_loop_ub; i32++) {
        ...
        if ((r3D.size(1) == r3.size(1)) && (r2D.size(1) == ud.size(1)) &&
            ...
            for (int i42{0}; i42 < cb_loop_ub; i42++) {
                ...
                k_vectorUB = k_scalarLB - 2;
                for (i43 = 0; i43 <= k_vectorUB; i43 += 2) {
                    __m128d r12;
                    __m128d r13;
                    __m128d r14;
                ...
                for (i43 = k_scalarLB; i43 < db_loop_ub; i43++) {
                    J[i43 + J.size(0) * i42] =
        ...
        if (y.size(1) == ud.size(1)) {
            ...
            l_vectorUB = l_scalarLB - 2;
            for (i51 = 0; i51 <= l_vectorUB; i51 += 2) {
                __m128d r15;
                __m128d r16;
            ...
            for (i51 = l_scalarLB; i51 < ib_loop_ub; i51++) {
        ...
        if (b_y) {
            ...
            m_vectorUB = m_scalarLB - 2;
            for (i55 = 0; i55 <= m_vectorUB; i55 += 2) {
                __m128d r17;
                r17 = _mm_loadu_pd(&feed[i55]);
                _mm_storeu_pd(&b_feed[i55], _mm_sub_pd(r17, _mm_set1_pd(b_fmax)));
            }
            for (i55 = m_scalarLB; i55 < kb_loop_ub; i55++) {
            ...
            if (c_y) {
                ...
                if (b_z1.size(0) == b_trueCount) {
                    ...
                    for (int i60{0}; i60 < nb_loop_ub; i60++) {
                        ...
                        n_scalarLB = (b_z1.size(0) / 2) << 1;
                        n_vectorUB = n_scalarLB - 2;
                        for (i64 = 0; i64 <= n_vectorUB; i64 += 2) {
                            __m128d r18;
                            __m128d r19;
                            r18 = _mm_loadu_pd(&b_z1[i64 + b_z1.size(0) * i60]);
                            r19 = _mm_loadu_pd(&vmax_data[i64]);
                            _mm_storeu_pd(&c_z1[i64 + c_z1.size(0) * i60], _mm_sub_pd(r18, r19));
                        }
                        for (i64 = n_scalarLB; i64 < pb_loop_ub; i64++) {
                            c_z1[i64 + c_z1.size(0) * i60] =
                                b_z1[i64 + b_z1.size(0) * i60] - vmax_data[i64];
                        }
                    }
                    b_z1.set_size(c_z1.size(0), c_z1.size(1));
                    ...
                    for (int i63{0}; i63 < rb_loop_ub; i63++) {
                        ...
                        for (int i65{0}; i65 < sb_loop_ub; i65++) {
                            b_z1[i65 + b_z1.size(0) * i63] = c_z1[i65 + c_z1.size(0) * i63];
                        }
                    }
                    coder::internal::b_maximum(b_z1, &v_delta, &b_iindx);
                } else {
                    ...
                    for (int i61{0}; i61 < ob_loop_ub; i61++) {
                        ...
                        for (int i62{0}; i62 < qb_loop_ub; i62++) {
                            b_x[i62 + b_x.size(0) * i61] =
                                (b_z1[i62 + b_z1.size(0) * i61] > amax_data[i62]);
                        }
                    }
                } else {
                    d_binary_expand_op(b_x, b_z1, amax_data, &c_trueCount);
                ...
                if (d_y) {
                    ...
                    if (b_z1.size(0) == c_trueCount) {
                        ...
                        for (int i68{0}; i68 < tb_loop_ub; i68++) {
                            ...
                            o_scalarLB = (b_z1.size(0) / 2) << 1;
                            o_vectorUB = o_scalarLB - 2;
                            for (i72 = 0; i72 <= o_vectorUB; i72 += 2) {
                                __m128d r20;
                                __m128d r21;
                                r20 = _mm_loadu_pd(&b_z1[i72 + b_z1.size(0) * i68]);
                                r21 = _mm_loadu_pd(&amax_data[i72]);
                                _mm_storeu_pd(&d_z1[i72 + d_z1.size(0) * i68],
                                              _mm_sub_pd(r20, r21));
                            }
                            for (i72 = o_scalarLB; i72 < vb_loop_ub; i72++) {
                                d_z1[i72 + d_z1.size(0) * i68] =
                                    b_z1[i72 + b_z1.size(0) * i68] - amax_data[i72];
                            }
                        }
                        b_z1.set_size(d_z1.size(0), d_z1.size(1));
                        ...
                        for (int i71{0}; i71 < xb_loop_ub; i71++) {
                            ...
                            for (int i73{0}; i73 < yb_loop_ub; i73++) {
                                b_z1[i73 + b_z1.size(0) * i71] = d_z1[i73 + d_z1.size(0) * i71];
                            }
                        }
                        coder::internal::b_maximum(b_z1, &a_delta, &c_iindx);
                    } else {
                    ...
                    if (b_z1.size(0) == d_trueCount) {
                        ...
                        for (int i69{0}; i69 < ub_loop_ub; i69++) {
                            ...
                            for (int i70{0}; i70 < wb_loop_ub; i70++) {
                                b_x[i70 + b_x.size(0) * i69] =
                                    (b_z1[i70 + b_z1.size(0) * i69] > jmax_data[i70]);
                            }
                        }
                    } else {
                        d_binary_expand_op(b_x, b_z1, jmax_data, &d_trueCount);
                    ...
                    if (e_y) {
                        ...
                        if (b_z1.size(0) == d_trueCount) {
                            ...
                            for (int i74{0}; i74 < ac_loop_ub; i74++) {
                                ...
                                p_scalarLB = (b_z1.size(0) / 2) << 1;
                                p_vectorUB = p_scalarLB - 2;
                                for (i76 = 0; i76 <= p_vectorUB; i76 += 2) {
                                    __m128d r22;
                                    __m128d r23;
                                    r22 = _mm_loadu_pd(&b_z1[i76 + b_z1.size(0) * i74]);
                                    r23 = _mm_loadu_pd(&jmax_data[i76]);
                                    _mm_storeu_pd(&e_z1[i76 + e_z1.size(0) * i74],
                                                  _mm_sub_pd(r22, r23));
                                }
                                for (i76 = p_scalarLB; i76 < bc_loop_ub; i76++) {
                                    e_z1[i76 + e_z1.size(0) * i74] =
                                        b_z1[i76 + b_z1.size(0) * i74] - jmax_data[i76];
                                }
                            }
                            b_z1.set_size(e_z1.size(0), e_z1.size(1));
                            ...
                            for (int i75{0}; i75 < cc_loop_ub; i75++) {
                                ...
                                for (int i77{0}; i77 < dc_loop_ub; i77++) {
                                    b_z1[i77 + b_z1.size(0) * i75] = e_z1[i77 + e_z1.size(0) * i75];
                                }
                            }
                            coder::internal::b_maximum(b_z1, &j_delta, &d_iindx);
                        } else {
    ...
    for (i7 = 0; i7 <= vectorUB; i7 += 2) {
        __m128d r;
        r = _mm_loadu_pd(&k_vec[i7]);
        _mm_storeu_pd(&y[i7], _mm_mul_pd(r, _mm_set1_pd(ctx_cfg_dt)));
    }
    for (i7 = scalarLB; i7 < d_loop_ub; i7++) {
    ...
    for (i9 = c_scalarLB; i9 < f_loop_ub; i9++) {
        udd[i9] = b_jps * y[i9];
    }
    // 'constJerkU:30' ud      = pseudoJerk .* k_vec .^2 / 2;
    r3.set_size(1, y.size(1));
    ...
    for (i11 = d_scalarLB; i11 < h_loop_ub; i11++) {
