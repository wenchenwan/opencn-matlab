                      ...
                      const double in8[5], double *beta0, double *beta1)
{
    ...
    t65 = 1.0 / ((((((((((((((((((((((((((((((((((-(in4[0] * in4[1] * in7[0] * in7[1] * 2.0) +
                                                  -(in4[0] * in4[2] * in7[0] * in7[2] * 2.0)) +
                                                 -(in4[0] * in4[3] * in7[0] * in7[3] * 2.0)) +
                                                -(in4[1] * in4[2] * in7[1] * in7[2] * 2.0)) +
                                               -(in4[0] * in4[4] * in7[0] * in7[4] * 2.0)) +
                                              -(in4[1] * in4[3] * in7[1] * in7[3] * 2.0)) +
                                             -(in4[1] * in4[4] * in7[1] * in7[4] * 2.0)) +
                                            -(in4[2] * in4[3] * in7[2] * in7[3] * 2.0)) +
                                           -(in4[2] * in4[4] * in7[2] * in7[4] * 2.0)) +
                                          -(in4[3] * in4[4] * in7[3] * in7[4] * 2.0)) +
                                         t9 * t15 * 9.0) +
                                        t10 * t14 * 9.0) +
                                       t9 * t16 * 9.0) +
                                      t11 * t14 * 9.0) +
    ...
    beta0_tmp = alpha0 * t9;
    b_beta0_tmp = alpha0 * t10;
    c_beta0_tmp = alpha0 * t11;
    d_beta0_tmp = alpha0 * t12;
    e_beta0_tmp = alpha0 * t13;
    f_beta0_tmp = alpha1 * t14;
    g_beta0_tmp = alpha1 * t16;
    h_beta0_tmp = alpha1 * t15;
    i_beta0_tmp = alpha1 * t17;
    j_beta0_tmp = alpha1 * t18;
    k_beta0_tmp = in5[0] * t7;
    l_beta0_tmp = in5[1] * t7;
    m_beta0_tmp = in5[2] * t7;
    n_beta0_tmp = in5[3] * t7;
    o_beta0_tmp = in5[4] * t7;
    p_beta0_tmp = in8[0] * t8;
    q_beta0_tmp = in8[1] * t8;
    r_beta0_tmp = in8[2] * t8;
    s_beta0_tmp = in8[3] * t8;
    t_beta0_tmp = in8[4] * t8;
    u_beta0_tmp = alpha0 * in4[0];
    v_beta0_tmp = alpha0 * in4[1];
    w_beta0_tmp = alpha0 * in4[2];
    x_beta0_tmp = in4[0] * in3[1];
    y_beta0_tmp = in4[0] * in3[2];
    ab_beta0_tmp = in4[0] * in3[3];
    bb_beta0_tmp = in4[1] * in3[2];
    cb_beta0_tmp = in4[0] * in3[4];
    db_beta0_tmp = in4[1] * in3[3];
    eb_beta0_tmp = in4[0] * in6[1];
    fb_beta0_tmp = in4[1] * in3[4];
    gb_beta0_tmp = in4[2] * in3[3];
    hb_beta0_tmp = in4[0] * in6[2];
    ib_beta0_tmp = in4[2] * in3[4];
    jb_beta0_tmp = in4[0] * in6[3];
    kb_beta0_tmp = in4[1] * in6[2];
    lb_beta0_tmp = in4[3] * in3[4];
    mb_beta0_tmp = in4[0] * in6[4];
    nb_beta0_tmp = in4[1] * in6[3];
    ob_beta0_tmp = in4[1] * in6[4];
    pb_beta0_tmp = in4[2] * in6[3];
    qb_beta0_tmp = in4[2] * in6[4];
    rb_beta0_tmp = in4[3] * in6[4];
    sb_beta0_tmp = alpha1 * in4[0];
    tb_beta0_tmp = alpha1 * in4[1];
    ub_beta0_tmp = alpha1 * in4[2];
    vb_beta0_tmp = alpha1 * in4[3];
    wb_beta0_tmp = l_beta0_tmp * in4[0];
    xb_beta0_tmp = m_beta0_tmp * in4[0];
    yb_beta0_tmp = n_beta0_tmp * in4[0];
    ac_beta0_tmp = m_beta0_tmp * in4[1];
    bc_beta0_tmp = o_beta0_tmp * in4[0];
    cc_beta0_tmp = n_beta0_tmp * in4[1];
    dc_beta0_tmp = q_beta0_tmp * in4[0];
    ec_beta0_tmp = o_beta0_tmp * in4[1];
    fc_beta0_tmp = n_beta0_tmp * in4[2];
    gc_beta0_tmp = r_beta0_tmp * in4[0];
    hc_beta0_tmp = o_beta0_tmp * in4[2];
    ic_beta0_tmp = s_beta0_tmp * in4[0];
    jc_beta0_tmp = r_beta0_tmp * in4[1];
    kc_beta0_tmp = o_beta0_tmp * in4[3];
    lc_beta0_tmp = t_beta0_tmp * in4[0];
    mc_beta0_tmp = s_beta0_tmp * in4[1];
    nc_beta0_tmp = t_beta0_tmp * in4[1];
    oc_beta0_tmp = s_beta0_tmp * in4[2];
    pc_beta0_tmp = t_beta0_tmp * in4[2];
    qc_beta0_tmp = t_beta0_tmp * in4[3];
    *beta0 =
        -t65 *
        ((((((((((((((((((((((((((((((((((beta0_tmp * t14 * 28.0 + b_beta0_tmp * t15 * 28.0) +
                                         c_beta0_tmp * t16 * 28.0) +
                                        d_beta0_tmp * t17 * 28.0) +
                                       e_beta0_tmp * t18 * 28.0) +
                                      in3[0] * t14 * in4[0] * 40.0) +
                                     in3[1] * t15 * in4[1] * 40.0) +
                                    in3[2] * t16 * in4[2] * 40.0) -
                                   in6[0] * t14 * in4[0] * 40.0) +
                                  in3[3] * t17 * in4[3] * 40.0) -
                                 in6[1] * t15 * in4[1] * 40.0) +
                                in3[4] * t18 * in4[4] * 40.0) -
                               in6[2] * t16 * in4[2] * 40.0) -
                              in6[3] * t17 * in4[3] * 40.0) -
                             in6[4] * t18 * in4[4] * 40.0) +
                            sb_beta0_tmp * std::pow(in7[0], 3.0) * 12.0) +
                           tb_beta0_tmp * std::pow(in7[1], 3.0) * 12.0) +
                          ub_beta0_tmp * std::pow(in7[2], 3.0) * 12.0) +
                         vb_beta0_tmp * std::pow(in7[3], 3.0) * 12.0) +
                        alpha1 * in4[4] * std::pow(in7[4], 3.0) * 12.0) +
                       beta0_tmp * t15 * 36.0) +
                      b_beta0_tmp * t14 * 36.0) +
                     beta0_tmp * t16 * 36.0) +
                    c_beta0_tmp * t14 * 36.0) +
                   beta0_tmp * t17 * 36.0) +
                  ((((((((((((((((((((((((d_beta0_tmp * t14 * 36.0 + b_beta0_tmp * t16 * 36.0) +
                                         c_beta0_tmp * t15 * 36.0) +
                                        beta0_tmp * t18 * 36.0) +
                                       e_beta0_tmp * t14 * 36.0) +
                                      b_beta0_tmp * t17 * 36.0) +
                                     d_beta0_tmp * t15 * 36.0) +
                                    b_beta0_tmp * t18 * 36.0) +
                                   e_beta0_tmp * t15 * 36.0) +
                                  c_beta0_tmp * t17 * 36.0) +
                                 d_beta0_tmp * t16 * 36.0) +
                                c_beta0_tmp * t18 * 36.0) +
                               e_beta0_tmp * t16 * 36.0) +
                              d_beta0_tmp * t18 * 36.0) +
                             e_beta0_tmp * t17 * 36.0) +
                            in3[0] * t15 * in4[0] * 60.0) +
                           in3[1] * t14 * in4[1] * 60.0) +
                          in3[0] * t16 * in4[0] * 60.0) +
                         in3[2] * t14 * in4[2] * 60.0) +
                        in3[0] * t17 * in4[0] * 60.0) +
                       in3[1] * t16 * in4[1] * 60.0) +
                      in3[0] * t18 * in4[0] * 60.0) +
                     in3[2] * t15 * in4[2] * 60.0) +
                    in3[3] * t14 * in4[3] * 60.0) +
                   in3[1] * t17 * in4[1] * 60.0)) +
                 ((((((((((((((((((((((in3[3] * t15 * in4[3] * 60.0 +
                                       in3[1] * t18 * in4[1] * 60.0) -
                                      in6[0] * t15 * in4[0] * 60.0) +
                                     in3[4] * t14 * in4[4] * 60.0) +
                                    in3[2] * t17 * in4[2] * 60.0) -
                                   in6[1] * t14 * in4[1] * 60.0) +
                                  in3[3] * t16 * in4[3] * 60.0) -
                                 in6[0] * t16 * in4[0] * 60.0) +
                                in3[4] * t15 * in4[4] * 60.0) +
                               in3[2] * t18 * in4[2] * 60.0) -
                              in6[2] * t14 * in4[2] * 60.0) -
                             in6[0] * t17 * in4[0] * 60.0) +
                            in3[4] * t16 * in4[4] * 60.0) -
                           in6[1] * t16 * in4[1] * 60.0) +
                          in3[3] * t18 * in4[3] * 60.0) -
                         in6[0] * t18 * in4[0] * 60.0) -
                        in6[2] * t15 * in4[2] * 60.0) +
                       in3[4] * t17 * in4[4] * 60.0) -
                      in6[3] * t14 * in4[3] * 60.0) -
                     in6[1] * t17 * in4[1] * 60.0) -
                    in6[3] * t15 * in4[3] * 60.0) -
                   in6[1] * t18 * in4[1] * 60.0) -
                  in6[4] * t14 * in4[4] * 60.0)) +
                (((((((((((((((((((((in6[2] * t17 * in4[2] * -60.0 - in6[3] * t16 * in4[3] * 60.0) -
                                    in6[4] * t15 * in4[4] * 60.0) -
                                   in6[2] * t18 * in4[2] * 60.0) -
                                  in6[4] * t16 * in4[4] * 60.0) -
                                 in6[3] * t18 * in4[3] * 60.0) -
                                in6[4] * t17 * in4[4] * 60.0) +
                               k_beta0_tmp * t14 * in4[0] * 8.0) +
                              l_beta0_tmp * t15 * in4[1] * 8.0) +
                             m_beta0_tmp * t16 * in4[2] * 8.0) +
                            n_beta0_tmp * t17 * in4[3] * 8.0) +
                           o_beta0_tmp * t18 * in4[4] * 8.0) +
                          h_beta0_tmp * in4[0] * in7[0] * 12.0) +
                         f_beta0_tmp * in4[1] * in7[1] * 12.0) +
                        g_beta0_tmp * in4[0] * in7[0] * 12.0) +
                       f_beta0_tmp * in4[2] * in7[2] * 12.0) +
                      i_beta0_tmp * in4[0] * in7[0] * 12.0) +
                     g_beta0_tmp * in4[1] * in7[1] * 12.0) +
                    j_beta0_tmp * in4[0] * in7[0] * 12.0) +
                   h_beta0_tmp * in4[2] * in7[2] * 12.0) +
                  f_beta0_tmp * in4[3] * in7[3] * 12.0) +
                 i_beta0_tmp * in4[1] * in7[1] * 12.0)) +
               (((((((((((((((((((((h_beta0_tmp * in4[3] * in7[3] * 12.0 +
                                    j_beta0_tmp * in4[1] * in7[1] * 12.0) +
                                   f_beta0_tmp * in4[4] * in7[4] * 12.0) +
                                  i_beta0_tmp * in4[2] * in7[2] * 12.0) +
                                 g_beta0_tmp * in4[3] * in7[3] * 12.0) +
                                h_beta0_tmp * in4[4] * in7[4] * 12.0) +
                               j_beta0_tmp * in4[2] * in7[2] * 12.0) +
                              g_beta0_tmp * in4[4] * in7[4] * 12.0) +
                             j_beta0_tmp * in4[3] * in7[3] * 12.0) +
                            i_beta0_tmp * in4[4] * in7[4] * 12.0) +
                           k_beta0_tmp * t15 * in4[0] * 9.0) +
                          l_beta0_tmp * t14 * in4[1] * 9.0) +
                         k_beta0_tmp * t16 * in4[0] * 9.0) +
                        m_beta0_tmp * t14 * in4[2] * 9.0) +
                       k_beta0_tmp * t17 * in4[0] * 9.0) +
                      l_beta0_tmp * t16 * in4[1] * 9.0) +
                     k_beta0_tmp * t18 * in4[0] * 9.0) +
                    m_beta0_tmp * t15 * in4[2] * 9.0) +
                   n_beta0_tmp * t14 * in4[3] * 9.0) +
                  l_beta0_tmp * t17 * in4[1] * 9.0) +
                 n_beta0_tmp * t15 * in4[3] * 9.0) +
                l_beta0_tmp * t18 * in4[1] * 9.0)) +
              (((((((((((((((((((((o_beta0_tmp * t14 * in4[4] * 9.0 +
                                   m_beta0_tmp * t17 * in4[2] * 9.0) -
                                  p_beta0_tmp * t15 * in4[0] * 3.0) +
                                 n_beta0_tmp * t16 * in4[3] * 9.0) -
                                q_beta0_tmp * t14 * in4[1] * 3.0) +
                               o_beta0_tmp * t15 * in4[4] * 9.0) +
                              m_beta0_tmp * t18 * in4[2] * 9.0) -
                             p_beta0_tmp * t16 * in4[0] * 3.0) +
                            o_beta0_tmp * t16 * in4[4] * 9.0) -
                           r_beta0_tmp * t14 * in4[2] * 3.0) -
                          p_beta0_tmp * t17 * in4[0] * 3.0) +
                         n_beta0_tmp * t18 * in4[3] * 9.0) -
                        q_beta0_tmp * t16 * in4[1] * 3.0) +
                       o_beta0_tmp * t17 * in4[4] * 9.0) -
                      p_beta0_tmp * t18 * in4[0] * 3.0) -
                     r_beta0_tmp * t15 * in4[2] * 3.0) -
                    s_beta0_tmp * t14 * in4[3] * 3.0) -
                   q_beta0_tmp * t17 * in4[1] * 3.0) -
                  s_beta0_tmp * t15 * in4[3] * 3.0) -
                 q_beta0_tmp * t18 * in4[1] * 3.0) -
                t_beta0_tmp * t14 * in4[4] * 3.0) -
               r_beta0_tmp * t17 * in4[2] * 3.0)) +
             (((((((((((((((((((s_beta0_tmp * t16 * in4[3] * -3.0 -
                                t_beta0_tmp * t15 * in4[4] * 3.0) -
                               r_beta0_tmp * t18 * in4[2] * 3.0) -
                              t_beta0_tmp * t16 * in4[4] * 3.0) -
                             s_beta0_tmp * t18 * in4[3] * 3.0) -
                            t_beta0_tmp * t17 * in4[4] * 3.0) -
                           in3[0] * in4[1] * in7[0] * in7[1] * 20.0) -
                          x_beta0_tmp * in7[0] * in7[1] * 20.0) -
                         in3[0] * in4[2] * in7[0] * in7[2] * 20.0) -
                        y_beta0_tmp * in7[0] * in7[2] * 20.0) -
                       in3[0] * in4[3] * in7[0] * in7[3] * 20.0) -
                      ab_beta0_tmp * in7[0] * in7[3] * 20.0) -
                     in3[1] * in4[2] * in7[1] * in7[2] * 20.0) -
                    bb_beta0_tmp * in7[1] * in7[2] * 20.0) -
                   in3[0] * in4[4] * in7[0] * in7[4] * 20.0) -
                  cb_beta0_tmp * in7[0] * in7[4] * 20.0) -
                 in3[1] * in4[3] * in7[1] * in7[3] * 20.0) -
                db_beta0_tmp * in7[1] * in7[3] * 20.0) +
               in6[0] * in4[1] * in7[0] * in7[1] * 20.0) +
              eb_beta0_tmp * in7[0] * in7[1] * 20.0)) +
            ((((((((((((((((((((in3[1] * in4[4] * in7[1] * in7[4] * -20.0 -
                                fb_beta0_tmp * in7[1] * in7[4] * 20.0) -
                               in3[2] * in4[3] * in7[2] * in7[3] * 20.0) -
                              gb_beta0_tmp * in7[2] * in7[3] * 20.0) +
                             in6[0] * in4[2] * in7[0] * in7[2] * 20.0) +
                            hb_beta0_tmp * in7[0] * in7[2] * 20.0) -
                           in3[2] * in4[4] * in7[2] * in7[4] * 20.0) -
                          ib_beta0_tmp * in7[2] * in7[4] * 20.0) +
                         in6[0] * in4[3] * in7[0] * in7[3] * 20.0) +
                        jb_beta0_tmp * in7[0] * in7[3] * 20.0) +
                       in6[1] * in4[2] * in7[1] * in7[2] * 20.0) +
                      kb_beta0_tmp * in7[1] * in7[2] * 20.0) -
                     in3[3] * in4[4] * in7[3] * in7[4] * 20.0) -
                    lb_beta0_tmp * in7[3] * in7[4] * 20.0) +
                   in6[0] * in4[4] * in7[0] * in7[4] * 20.0) +
                  mb_beta0_tmp * in7[0] * in7[4] * 20.0) +
                 in6[1] * in4[3] * in7[1] * in7[3] * 20.0) +
                nb_beta0_tmp * in7[1] * in7[3] * 20.0) +
               in6[1] * in4[4] * in7[1] * in7[4] * 20.0) +
              ob_beta0_tmp * in7[1] * in7[4] * 20.0) +
             in6[2] * in4[3] * in7[2] * in7[3] * 20.0)) +
           ((((((((((((((((((pb_beta0_tmp * in7[2] * in7[3] * 20.0 +
                             in6[2] * in4[4] * in7[2] * in7[4] * 20.0) +
                            qb_beta0_tmp * in7[2] * in7[4] * 20.0) +
                           in6[3] * in4[4] * in7[3] * in7[4] * 20.0) +
                          rb_beta0_tmp * in7[3] * in7[4] * 20.0) -
                         u_beta0_tmp * in4[1] * in7[0] * in7[1] * 16.0) -
                        u_beta0_tmp * in4[2] * in7[0] * in7[2] * 16.0) -
                       u_beta0_tmp * in4[3] * in7[0] * in7[3] * 16.0) -
                      v_beta0_tmp * in4[2] * in7[1] * in7[2] * 16.0) -
                     u_beta0_tmp * in4[4] * in7[0] * in7[4] * 16.0) -
                    v_beta0_tmp * in4[3] * in7[1] * in7[3] * 16.0) -
                   v_beta0_tmp * in4[4] * in7[1] * in7[4] * 16.0) -
                  w_beta0_tmp * in4[3] * in7[2] * in7[3] * 16.0) -
                 w_beta0_tmp * in4[4] * in7[2] * in7[4] * 16.0) -
                alpha0 * in4[3] * in4[4] * in7[3] * in7[4] * 16.0) -
               k_beta0_tmp * in4[1] * in7[0] * in7[1]) -
              wb_beta0_tmp * in7[0] * in7[1]) -
             k_beta0_tmp * in4[2] * in7[0] * in7[2]) -
            xb_beta0_tmp * in7[0] * in7[2])) +
          (((((((((((((((((((-in5[0] * t7 * in4[3] * in7[0] * in7[3] -
                             yb_beta0_tmp * in7[0] * in7[3]) -
                            l_beta0_tmp * in4[2] * in7[1] * in7[2]) -
                           ac_beta0_tmp * in7[1] * in7[2]) -
                          k_beta0_tmp * in4[4] * in7[0] * in7[4]) -
                         bc_beta0_tmp * in7[0] * in7[4]) -
                        l_beta0_tmp * in4[3] * in7[1] * in7[3]) -
                       cc_beta0_tmp * in7[1] * in7[3]) +
                      p_beta0_tmp * in4[1] * in7[0] * in7[1] * 3.0) +
                     dc_beta0_tmp * in7[0] * in7[1] * 3.0) -
                    l_beta0_tmp * in4[4] * in7[1] * in7[4]) -
                   ec_beta0_tmp * in7[1] * in7[4]) -
                  m_beta0_tmp * in4[3] * in7[2] * in7[3]) -
                 fc_beta0_tmp * in7[2] * in7[3]) +
                p_beta0_tmp * in4[2] * in7[0] * in7[2] * 3.0) +
               gc_beta0_tmp * in7[0] * in7[2] * 3.0) -
              m_beta0_tmp * in4[4] * in7[2] * in7[4]) -
             hc_beta0_tmp * in7[2] * in7[4]) +
            p_beta0_tmp * in4[3] * in7[0] * in7[3] * 3.0) +
           ic_beta0_tmp * in7[0] * in7[3] * 3.0)) +
         (((((((((((((((q_beta0_tmp * in4[2] * in7[1] * in7[2] * 3.0 +
                        jc_beta0_tmp * in7[1] * in7[2] * 3.0) -
                       n_beta0_tmp * in4[4] * in7[3] * in7[4]) -
                      kc_beta0_tmp * in7[3] * in7[4]) +
                     p_beta0_tmp * in4[4] * in7[0] * in7[4] * 3.0) +
                    lc_beta0_tmp * in7[0] * in7[4] * 3.0) +
                   q_beta0_tmp * in4[3] * in7[1] * in7[3] * 3.0) +
                  mc_beta0_tmp * in7[1] * in7[3] * 3.0) +
                 q_beta0_tmp * in4[4] * in7[1] * in7[4] * 3.0) +
                nc_beta0_tmp * in7[1] * in7[4] * 3.0) +
               r_beta0_tmp * in4[3] * in7[2] * in7[3] * 3.0) +
              oc_beta0_tmp * in7[2] * in7[3] * 3.0) +
             r_beta0_tmp * in4[4] * in7[2] * in7[4] * 3.0) +
            pc_beta0_tmp * in7[2] * in7[4] * 3.0) +
           s_beta0_tmp * in4[4] * in7[3] * in7[4] * 3.0) +
          qc_beta0_tmp * in7[3] * in7[4] * 3.0));
    ...
    beta1_tmp = alpha1 * t9;
    b_beta1_tmp = alpha1 * t10;
    c_beta1_tmp = alpha1 * t11;
    d_beta1_tmp = alpha1 * t12;
    e_beta1_tmp = alpha1 * t13;
    f_beta1_tmp = in3[0] * in4[0];
    g_beta1_tmp = in3[1] * in4[1];
    h_beta1_tmp = in6[0] * in4[0];
    i_beta1_tmp = in3[2] * in4[2];
    j_beta1_tmp = in6[1] * in4[1];
    k_beta1_tmp = in6[2] * in4[2];
    l_beta1_tmp = k_beta0_tmp * in4[0];
    m_beta1_tmp = l_beta0_tmp * in4[1];
    n_beta1_tmp = p_beta0_tmp * in4[0];
    o_beta1_tmp = m_beta0_tmp * in4[2];
    p_beta1_tmp = q_beta0_tmp * in4[1];
    q_beta1_tmp = r_beta0_tmp * in4[2];
    *beta1 =
        t65 *
        ((((((((((((((((((((((((((((((((((beta1_tmp * t14 * 28.0 + b_beta1_tmp * t15 * 28.0) +
                                         c_beta1_tmp * t16 * 28.0) +
                                        d_beta1_tmp * t17 * 28.0) +
                                       e_beta1_tmp * t18 * 28.0) +
                                      in3[0] * t9 * in7[0] * 40.0) +
                                     in3[1] * t10 * in7[1] * 40.0) +
                                    in3[2] * t11 * in7[2] * 40.0) -
                                   in6[0] * t9 * in7[0] * 40.0) +
                                  in3[3] * t12 * in7[3] * 40.0) -
                                 in6[1] * t10 * in7[1] * 40.0) +
                                in3[4] * t13 * in7[4] * 40.0) -
                               in6[2] * t11 * in7[2] * 40.0) -
                              in6[3] * t12 * in7[3] * 40.0) -
                             in6[4] * t13 * in7[4] * 40.0) +
                            alpha0 * std::pow(in4[0], 3.0) * in7[0] * 12.0) +
                           alpha0 * std::pow(in4[1], 3.0) * in7[1] * 12.0) +
                          alpha0 * std::pow(in4[2], 3.0) * in7[2] * 12.0) +
                         alpha0 * std::pow(in4[3], 3.0) * in7[3] * 12.0) +
                        alpha0 * std::pow(in4[4], 3.0) * in7[4] * 12.0) +
                       beta1_tmp * t15 * 36.0) +
                      b_beta1_tmp * t14 * 36.0) +
                     beta1_tmp * t16 * 36.0) +
                    c_beta1_tmp * t14 * 36.0) +
                   beta1_tmp * t17 * 36.0) +
                  ((((((((((((((((((((((((d_beta1_tmp * t14 * 36.0 + b_beta1_tmp * t16 * 36.0) +
                                         c_beta1_tmp * t15 * 36.0) +
                                        beta1_tmp * t18 * 36.0) +
                                       e_beta1_tmp * t14 * 36.0) +
                                      b_beta1_tmp * t17 * 36.0) +
                                     d_beta1_tmp * t15 * 36.0) +
                                    b_beta1_tmp * t18 * 36.0) +
                                   e_beta1_tmp * t15 * 36.0) +
                                  c_beta1_tmp * t17 * 36.0) +
                                 d_beta1_tmp * t16 * 36.0) +
                                c_beta1_tmp * t18 * 36.0) +
                               e_beta1_tmp * t16 * 36.0) +
                              d_beta1_tmp * t18 * 36.0) +
                             e_beta1_tmp * t17 * 36.0) +
                            in3[0] * t10 * in7[0] * 60.0) +
                           in3[1] * t9 * in7[1] * 60.0) +
                          in3[0] * t11 * in7[0] * 60.0) +
                         in3[2] * t9 * in7[2] * 60.0) +
                        in3[0] * t12 * in7[0] * 60.0) +
                       in3[1] * t11 * in7[1] * 60.0) +
                      in3[0] * t13 * in7[0] * 60.0) +
                     in3[2] * t10 * in7[2] * 60.0) +
                    in3[3] * t9 * in7[3] * 60.0) +
                   in3[1] * t12 * in7[1] * 60.0)) +
                 ((((((((((((((((((((((in3[3] * t10 * in7[3] * 60.0 +
                                       in3[1] * t13 * in7[1] * 60.0) -
                                      in6[0] * t10 * in7[0] * 60.0) +
                                     in3[4] * t9 * in7[4] * 60.0) +
                                    in3[2] * t12 * in7[2] * 60.0) -
                                   in6[1] * t9 * in7[1] * 60.0) +
                                  in3[3] * t11 * in7[3] * 60.0) -
                                 in6[0] * t11 * in7[0] * 60.0) +
                                in3[4] * t10 * in7[4] * 60.0) +
                               in3[2] * t13 * in7[2] * 60.0) -
                              in6[2] * t9 * in7[2] * 60.0) -
                             in6[0] * t12 * in7[0] * 60.0) +
                            in3[4] * t11 * in7[4] * 60.0) -
                           in6[1] * t11 * in7[1] * 60.0) +
                          in3[3] * t13 * in7[3] * 60.0) -
                         in6[0] * t13 * in7[0] * 60.0) -
                        in6[2] * t10 * in7[2] * 60.0) +
                       in3[4] * t12 * in7[4] * 60.0) -
                      in6[3] * t9 * in7[3] * 60.0) -
                     in6[1] * t12 * in7[1] * 60.0) -
                    in6[3] * t10 * in7[3] * 60.0) -
                   in6[1] * t13 * in7[1] * 60.0) -
                  in6[4] * t9 * in7[4] * 60.0)) +
                (((((((((((((((((((((in6[2] * t12 * in7[2] * -60.0 - in6[3] * t11 * in7[3] * 60.0) -
                                    in6[4] * t10 * in7[4] * 60.0) -
                                   in6[2] * t13 * in7[2] * 60.0) -
                                  in6[4] * t11 * in7[4] * 60.0) -
                                 in6[3] * t13 * in7[3] * 60.0) -
                                in6[4] * t12 * in7[4] * 60.0) -
                               p_beta0_tmp * t9 * in7[0] * 8.0) -
                              q_beta0_tmp * t10 * in7[1] * 8.0) -
                             r_beta0_tmp * t11 * in7[2] * 8.0) -
                            s_beta0_tmp * t12 * in7[3] * 8.0) -
                           t_beta0_tmp * t13 * in7[4] * 8.0) +
                          b_beta0_tmp * in4[0] * in7[0] * 12.0) +
                         beta0_tmp * in4[1] * in7[1] * 12.0) +
                        c_beta0_tmp * in4[0] * in7[0] * 12.0) +
                       beta0_tmp * in4[2] * in7[2] * 12.0) +
                      d_beta0_tmp * in4[0] * in7[0] * 12.0) +
                     c_beta0_tmp * in4[1] * in7[1] * 12.0) +
                    e_beta0_tmp * in4[0] * in7[0] * 12.0) +
                   b_beta0_tmp * in4[2] * in7[2] * 12.0) +
                  beta0_tmp * in4[3] * in7[3] * 12.0) +
                 d_beta0_tmp * in4[1] * in7[1] * 12.0)) +
               ((((((((((((((((((((((b_beta0_tmp * in4[3] * in7[3] * 12.0 +
                                     e_beta0_tmp * in4[1] * in7[1] * 12.0) +
                                    beta0_tmp * in4[4] * in7[4] * 12.0) +
                                   d_beta0_tmp * in4[2] * in7[2] * 12.0) +
                                  c_beta0_tmp * in4[3] * in7[3] * 12.0) +
                                 b_beta0_tmp * in4[4] * in7[4] * 12.0) +
                                e_beta0_tmp * in4[2] * in7[2] * 12.0) +
                               c_beta0_tmp * in4[4] * in7[4] * 12.0) +
                              e_beta0_tmp * in4[3] * in7[3] * 12.0) +
                             d_beta0_tmp * in4[4] * in7[4] * 12.0) +
                            k_beta0_tmp * t10 * in7[0] * 3.0) +
                           l_beta0_tmp * t9 * in7[1] * 3.0) +
                          k_beta0_tmp * t11 * in7[0] * 3.0) +
                         m_beta0_tmp * t9 * in7[2] * 3.0) +
                        k_beta0_tmp * t12 * in7[0] * 3.0) +
                       l_beta0_tmp * t11 * in7[1] * 3.0) +
                      k_beta0_tmp * t13 * in7[0] * 3.0) +
                     m_beta0_tmp * t10 * in7[2] * 3.0) +
                    n_beta0_tmp * t9 * in7[3] * 3.0) +
                   l_beta0_tmp * t12 * in7[1] * 3.0) +
                  n_beta0_tmp * t10 * in7[3] * 3.0) +
                 l_beta0_tmp * t13 * in7[1] * 3.0) +
                o_beta0_tmp * t9 * in7[4] * 3.0)) +
              ((((((((((((((((((((m_beta0_tmp * t12 * in7[2] * 3.0 -
                                  p_beta0_tmp * t10 * in7[0] * 9.0) +
                                 n_beta0_tmp * t11 * in7[3] * 3.0) -
                                q_beta0_tmp * t9 * in7[1] * 9.0) +
                               o_beta0_tmp * t10 * in7[4] * 3.0) +
                              m_beta0_tmp * t13 * in7[2] * 3.0) -
                             p_beta0_tmp * t11 * in7[0] * 9.0) +
                            o_beta0_tmp * t11 * in7[4] * 3.0) -
                           r_beta0_tmp * t9 * in7[2] * 9.0) -
                          p_beta0_tmp * t12 * in7[0] * 9.0) +
                         n_beta0_tmp * t13 * in7[3] * 3.0) -
                        q_beta0_tmp * t11 * in7[1] * 9.0) +
                       o_beta0_tmp * t12 * in7[4] * 3.0) -
                      p_beta0_tmp * t13 * in7[0] * 9.0) -
                     r_beta0_tmp * t10 * in7[2] * 9.0) -
                    s_beta0_tmp * t9 * in7[3] * 9.0) -
                   q_beta0_tmp * t12 * in7[1] * 9.0) -
                  s_beta0_tmp * t10 * in7[3] * 9.0) -
                 q_beta0_tmp * t13 * in7[1] * 9.0) -
                t_beta0_tmp * t9 * in7[4] * 9.0) -
               r_beta0_tmp * t12 * in7[2] * 9.0)) +
             (((((((((((((((((((s_beta0_tmp * t11 * in7[3] * -9.0 -
                                t_beta0_tmp * t10 * in7[4] * 9.0) -
                               r_beta0_tmp * t13 * in7[2] * 9.0) -
                              t_beta0_tmp * t11 * in7[4] * 9.0) -
                             s_beta0_tmp * t13 * in7[3] * 9.0) -
                            t_beta0_tmp * t12 * in7[4] * 9.0) -
                           f_beta1_tmp * in4[1] * in7[1] * 20.0) -
                          x_beta0_tmp * in4[1] * in7[0] * 20.0) -
                         f_beta1_tmp * in4[2] * in7[2] * 20.0) -
                        y_beta0_tmp * in4[2] * in7[0] * 20.0) -
                       f_beta1_tmp * in4[3] * in7[3] * 20.0) -
                      ab_beta0_tmp * in4[3] * in7[0] * 20.0) -
                     g_beta1_tmp * in4[2] * in7[2] * 20.0) -
                    bb_beta0_tmp * in4[2] * in7[1] * 20.0) -
                   f_beta1_tmp * in4[4] * in7[4] * 20.0) -
                  cb_beta0_tmp * in4[4] * in7[0] * 20.0) -
                 g_beta1_tmp * in4[3] * in7[3] * 20.0) -
                db_beta0_tmp * in4[3] * in7[1] * 20.0) +
               h_beta1_tmp * in4[1] * in7[1] * 20.0) +
              eb_beta0_tmp * in4[1] * in7[0] * 20.0)) +
            ((((((((((((((((((((g_beta1_tmp * in4[4] * in7[4] * -20.0 -
                                fb_beta0_tmp * in4[4] * in7[1] * 20.0) -
                               i_beta1_tmp * in4[3] * in7[3] * 20.0) -
                              gb_beta0_tmp * in4[3] * in7[2] * 20.0) +
                             h_beta1_tmp * in4[2] * in7[2] * 20.0) +
                            hb_beta0_tmp * in4[2] * in7[0] * 20.0) -
                           i_beta1_tmp * in4[4] * in7[4] * 20.0) -
                          ib_beta0_tmp * in4[4] * in7[2] * 20.0) +
                         h_beta1_tmp * in4[3] * in7[3] * 20.0) +
                        jb_beta0_tmp * in4[3] * in7[0] * 20.0) +
                       j_beta1_tmp * in4[2] * in7[2] * 20.0) +
                      kb_beta0_tmp * in4[2] * in7[1] * 20.0) -
                     in3[3] * in4[3] * in4[4] * in7[4] * 20.0) -
                    lb_beta0_tmp * in4[4] * in7[3] * 20.0) +
                   h_beta1_tmp * in4[4] * in7[4] * 20.0) +
                  mb_beta0_tmp * in4[4] * in7[0] * 20.0) +
                 j_beta1_tmp * in4[3] * in7[3] * 20.0) +
                nb_beta0_tmp * in4[3] * in7[1] * 20.0) +
               j_beta1_tmp * in4[4] * in7[4] * 20.0) +
              ob_beta0_tmp * in4[4] * in7[1] * 20.0) +
             k_beta1_tmp * in4[3] * in7[3] * 20.0)) +
           ((((((((((((((((((pb_beta0_tmp * in4[3] * in7[2] * 20.0 +
                             k_beta1_tmp * in4[4] * in7[4] * 20.0) +
                            qb_beta0_tmp * in4[4] * in7[2] * 20.0) +
                           in6[3] * in4[3] * in4[4] * in7[4] * 20.0) +
                          rb_beta0_tmp * in4[4] * in7[3] * 20.0) -
                         sb_beta0_tmp * in4[1] * in7[0] * in7[1] * 16.0) -
                        sb_beta0_tmp * in4[2] * in7[0] * in7[2] * 16.0) -
                       sb_beta0_tmp * in4[3] * in7[0] * in7[3] * 16.0) -
                      tb_beta0_tmp * in4[2] * in7[1] * in7[2] * 16.0) -
                     sb_beta0_tmp * in4[4] * in7[0] * in7[4] * 16.0) -
                    tb_beta0_tmp * in4[3] * in7[1] * in7[3] * 16.0) -
                   tb_beta0_tmp * in4[4] * in7[1] * in7[4] * 16.0) -
                  ub_beta0_tmp * in4[3] * in7[2] * in7[3] * 16.0) -
                 ub_beta0_tmp * in4[4] * in7[2] * in7[4] * 16.0) -
                vb_beta0_tmp * in4[4] * in7[3] * in7[4] * 16.0) -
               l_beta1_tmp * in4[1] * in7[1] * 3.0) -
              wb_beta0_tmp * in4[1] * in7[0] * 3.0) -
             l_beta1_tmp * in4[2] * in7[2] * 3.0) -
            xb_beta0_tmp * in4[2] * in7[0] * 3.0)) +
          ((((((((((((((((((((l_beta1_tmp * in4[3] * in7[3] * -3.0 -
                              yb_beta0_tmp * in4[3] * in7[0] * 3.0) -
                             m_beta1_tmp * in4[2] * in7[2] * 3.0) -
                            ac_beta0_tmp * in4[2] * in7[1] * 3.0) -
                           l_beta1_tmp * in4[4] * in7[4] * 3.0) -
                          bc_beta0_tmp * in4[4] * in7[0] * 3.0) -
                         m_beta1_tmp * in4[3] * in7[3] * 3.0) -
                        cc_beta0_tmp * in4[3] * in7[1] * 3.0) +
                       n_beta1_tmp * in4[1] * in7[1]) +
                      dc_beta0_tmp * in4[1] * in7[0]) -
                     m_beta1_tmp * in4[4] * in7[4] * 3.0) -
                    ec_beta0_tmp * in4[4] * in7[1] * 3.0) -
                   o_beta1_tmp * in4[3] * in7[3] * 3.0) -
                  fc_beta0_tmp * in4[3] * in7[2] * 3.0) +
                 n_beta1_tmp * in4[2] * in7[2]) +
                gc_beta0_tmp * in4[2] * in7[0]) -
               o_beta1_tmp * in4[4] * in7[4] * 3.0) -
              hc_beta0_tmp * in4[4] * in7[2] * 3.0) +
             n_beta1_tmp * in4[3] * in7[3]) +
            ic_beta0_tmp * in4[3] * in7[0]) +
           p_beta1_tmp * in4[2] * in7[2])) +
         ((((((((((((((jc_beta0_tmp * in4[2] * in7[1] -
                       n_beta0_tmp * in4[3] * in4[4] * in7[4] * 3.0) -
                      kc_beta0_tmp * in4[4] * in7[3] * 3.0) +
                     n_beta1_tmp * in4[4] * in7[4]) +
                    lc_beta0_tmp * in4[4] * in7[0]) +
                   p_beta1_tmp * in4[3] * in7[3]) +
                  mc_beta0_tmp * in4[3] * in7[1]) +
                 p_beta1_tmp * in4[4] * in7[4]) +
                nc_beta0_tmp * in4[4] * in7[1]) +
               q_beta1_tmp * in4[3] * in7[3]) +
              oc_beta0_tmp * in4[3] * in7[2]) +
             q_beta1_tmp * in4[4] * in7[4]) +
            pc_beta0_tmp * in4[4] * in7[2]) +
           s_beta0_tmp * in4[3] * in4[4] * in7[4]) +
          qc_beta0_tmp * in4[4] * in7[3]));
}
