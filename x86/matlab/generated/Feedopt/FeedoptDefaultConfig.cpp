...
void FeedoptDefaultConfig(FeedoptConfig *cfg)
{
    ...
    // 'FeedoptDefaultConfig:61'     'CutOff', 1E-1,...
    ...
    // 'FeedoptDefaultConfig:72'     'ZeroStartVelLimit', 0.5, ...
    // 'FeedoptDefaultConfig:73'     'source', repmat(char(0), [1, 1024]),...
    // 'FeedoptDefaultConfig:74'     'DebugCutZero', false,...
    // 'FeedoptDefaultConfig:75'     'Cusp', ...
    // 'FeedoptDefaultConfig:76'     struct(...
    // 'FeedoptDefaultConfig:77'         'Skip', false,...
    // 'FeedoptDefaultConfig:78'         'CuspThreshold', 10 ...
    // 'FeedoptDefaultConfig:79'     ),...
    // 'FeedoptDefaultConfig:80'     'Compressing', ...
    // 'FeedoptDefaultConfig:81'     struct(...
    // 'FeedoptDefaultConfig:82'         'Skip', false,...
    // 'FeedoptDefaultConfig:83'         'ColTolCosLee',     cosd(tol_col_compress_deg) ...
    // 'FeedoptDefaultConfig:84'     ),...
    // 'FeedoptDefaultConfig:85'     'Smoothing', ...
    // 'FeedoptDefaultConfig:86'     struct( ...
    // 'FeedoptDefaultConfig:87'         'Skip', false,...
    // 'FeedoptDefaultConfig:88'         'ColTolCosSmooth',  cosd(tol_col_smooth_deg), ...
    // 'FeedoptDefaultConfig:89'         'ColTolSmooth',     1E-5 ...
    // 'FeedoptDefaultConfig:90'     ),...
    // 'FeedoptDefaultConfig:91'     'GaussLegendreN', GaussLegendreN, ...
    // 'FeedoptDefaultConfig:92'     'GaussLegendreX', GaussLegendreX, ...
    // 'FeedoptDefaultConfig:93'     'GaussLegendreW', GaussLegendreW, ...
    // 'FeedoptDefaultConfig:94'     'opt', LP,...
    // 'FeedoptDefaultConfig:95'     'LogFileName', 'logs/logs');
    ...
    //  %[mm] [rad]
    // 'FeedoptDefaultConfig:97' coder.varsize( 'cfg.indCart',   StructTypeName.dimInd{ : } );
    // 'FeedoptDefaultConfig:98' coder.varsize( 'cfg.indRot',    StructTypeName.dimInd{ : } );
    // 'FeedoptDefaultConfig:99' coder.varsize( 'cfg.maskTot',   StructTypeName.dimMask{ : } );
    // 'FeedoptDefaultConfig:100' coder.varsize( 'cfg.maskCart',  StructTypeName.dimMask{ : } );
    // 'FeedoptDefaultConfig:101' coder.varsize( 'cfg.maskRot',   StructTypeName.dimMask{ : } );
    // 'FeedoptDefaultConfig:102' coder.varsize( 'cfg.D',         StructTypeName.dimD{ : } );
    // 'FeedoptDefaultConfig:103' coder.varsize( 'cfg.kin_params',StructTypeName.dimKinParams{ : }
    // ); 'FeedoptDefaultConfig:104' coder.cstructname( cfg,         StructTypeName.FeedoptCfg );
    // 'FeedoptDefaultConfig:106' [ cfg ] = setMachineAxisInConfig( cfg, cfg.maskTot );
    r.maskTot.size[0] = 1;
    r.maskTot.size[1] = 6;
    for (int i{0}; i < 6; i++) {
