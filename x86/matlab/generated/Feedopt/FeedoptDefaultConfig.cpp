...
void FeedoptDefaultConfig(FeedoptConfig *cfg)
{
    ...
    // 'FeedoptDefaultConfig:22' if( ~coder.target('MATLAB') )
    // 'FeedoptDefaultConfig:23' coder.cstructname( LP,          StructTypeName.LPCfg );
    // 'FeedoptDefaultConfig:26' machine_off = [0; 0; 0];
    //  mx, my, mz
    // 'FeedoptDefaultConfig:27' piece_off   = [0; 0; -24.8760];
    //  px, py, pz
    // 'FeedoptDefaultConfig:28' tool_off    = [0; 0; 0];
    //  tx, ty, tz
    // 'FeedoptDefaultConfig:29' other_off   = [24.8760; 0; 0];
    //  d1, d2, tool_length
    // 'FeedoptDefaultConfig:32' kin_params = [machine_off, piece_off, tool_off, other_off];
    // 'FeedoptDefaultConfig:34' cfg = struct(...
    // 'FeedoptDefaultConfig:35'     'maskTot',  logical( [ 1, 1, 1, 0, 1, 1 ] ),... % [X,Y,Z,A,B,C]
    // 'FeedoptDefaultConfig:36'     'maskCart', logical( 0 ),...                    % Do not modify
    // 'FeedoptDefaultConfig:37'     'maskRot',  logical( 0 ),...                    % Do not modify
    // 'FeedoptDefaultConfig:38'     'indCart', int32( 0 ), ...                      % Do not modify
    // 'FeedoptDefaultConfig:39'     'indRot',  int32( 0 ),...                       % Do not modify
    // 'FeedoptDefaultConfig:40'     'NumberAxis', int32( 0 ), ...                   % Do not modify
    // 'FeedoptDefaultConfig:41'     'NCart',   int32( 0 ), ...                      % Do not modify
    // 'FeedoptDefaultConfig:42'     'NRot',    int32( 0 ), ...                      % Do not modify
    // 'FeedoptDefaultConfig:43'     'D', 0, ...                                     % Do not modify
    // 'FeedoptDefaultConfig:44'     'coeffD', 1, ...                                % Coefficient
    // between cartésian and rotativ axis 'FeedoptDefaultConfig:45'     'kin_params', reshape(
    // kin_params, [], 1 ), ... 'FeedoptDefaultConfig:46'     'kin_type', 'xyzbc', ...
    // 'FeedoptDefaultConfig:47'     'NDiscr', int32( 20 ),...
    // 'FeedoptDefaultConfig:48'     'NBreak', int32( 10 ),...
    // 'FeedoptDefaultConfig:49'     'UseDynamicBreakpoints',false,...       % Use a variable number
    // of breakpoints for different lengths 'FeedoptDefaultConfig:50'
    // 'UseLinearBreakpoints',false,...        % Use a linear distribution of breakpoints (else
    // sinspace) 'FeedoptDefaultConfig:51'     'DynamicBreakpointsDistance', 0.1,...   % Distance
    // between two breakpoints in mm 'FeedoptDefaultConfig:52'     'NHorz', int32( 10 ),...
    // 'FeedoptDefaultConfig:53'     'fmax', 1000,...
    // 'FeedoptDefaultConfig:54'     'smax', 75000,...
    // 'FeedoptDefaultConfig:55'     'vmax', [500,500,800,0, 40,50],... %[mm] [rad]
    // 'FeedoptDefaultConfig:56'     'amax', [15000,15000,15000,0, 200,1000],...
    // 'FeedoptDefaultConfig:57'     'jmax', [750000,750000,3000000,0,10000,50000],...
    // 'FeedoptDefaultConfig:58'     'LeeSplineDegree', int32( 4 ),...
    // 'FeedoptDefaultConfig:59'     'SplineDegree',    int32( 3 ),...
    // 'FeedoptDefaultConfig:60'     'CutOff', 1E-3,...
    // 'FeedoptDefaultConfig:61'     'LSplit',  3,...
    // 'FeedoptDefaultConfig:62'     'LSplitZero', 1E-1,...
    // 'FeedoptDefaultConfig:63'     'LThresholdMax', 5.0,...
    // 'FeedoptDefaultConfig:64'     'LThresholdMin', 0.001,...
    // 'FeedoptDefaultConfig:65'     'v_0', 0, 'at_0', 0,...
    // 'FeedoptDefaultConfig:66'     'v_1', 0, 'at_1', 0,...
    // 'FeedoptDefaultConfig:67'     'dt', 1e-2, ...
    // 'FeedoptDefaultConfig:68'     'ZeroStartAccLimit', 0.01, ...
    // 'FeedoptDefaultConfig:69'     'ZeroStartJerkLimit', 1E6, ...
    // 'FeedoptDefaultConfig:70'     'ZeroStartVelLimit', 0.5, ...
    // 'FeedoptDefaultConfig:71'     'source', repmat(char(0), [1, 1024]),...
    // 'FeedoptDefaultConfig:72'     'DebugCutZero', false,...
    // 'FeedoptDefaultConfig:73'     'Cusp', struct(...
    // 'FeedoptDefaultConfig:74'     'Skip', false,...
    // 'FeedoptDefaultConfig:75'     'CuspThreshold', 50 ),...
    // 'FeedoptDefaultConfig:76'     'Compressing', struct(...
    // 'FeedoptDefaultConfig:77'     'Skip', false,...
    // 'FeedoptDefaultConfig:78'     'ColTolCosLee',     cosd(tol_col_compress_deg)),...
    // 'FeedoptDefaultConfig:79'     'Smoothing', struct( ...
    // 'FeedoptDefaultConfig:80'     'Skip', false,...
    // 'FeedoptDefaultConfig:81'     'ColTolCosSmooth',  cosd(tol_col_smooth_deg), ...
    // 'FeedoptDefaultConfig:82'     'ColTolSmooth',     1E-5 ),...
    // 'FeedoptDefaultConfig:83'     'GaussLegendreN', GaussLegendreN, ...
    // 'FeedoptDefaultConfig:84'     'GaussLegendreX', GaussLegendreX, ...
    // 'FeedoptDefaultConfig:85'     'GaussLegendreW', GaussLegendreW, ...
    // 'FeedoptDefaultConfig:86'     'opt', LP,...
    // 'FeedoptDefaultConfig:87'     'LogFileName', 'logs/logs');
