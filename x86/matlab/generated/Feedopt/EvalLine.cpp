              ...
              ::coder::array<double, 2U> &r2D, ::coder::array<double, 2U> &r3D)
{
    ...
    for (int i2{0}; i2 < loop_ub; i2++) {
        ...
        for (i3 = 0; i3 <= vectorUB; i3 += 2) {
            ...
            _mm_storeu_pd(
                &r0D[i3 + r0D.size(0) * i2],
                _mm_add_pd(_mm_mul_pd(r, _mm_set1_pd(d)), _mm_mul_pd(r1, _mm_set1_pd(1.0 - d))));
        }
        for (i3 = scalarLB; i3 < ind_size; i3++) {
            double d1;
            d1 = u_vec[i2];
    ...
    for (i4 = b_scalarLB; i4 < ind_size; i4++) {
              ...
              int *r3D_size)
{
    ...
    *r0D_size = ind_size;
    ...
    for (i2 = scalarLB; i2 < ind_size; i2++) {
    ...
    for (i3 = b_scalarLB; i3 < ind_size; i3++) {
