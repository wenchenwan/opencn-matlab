...
//
// Arguments    : ::coder::array<double, 2U> &r1
                        ...
                        double e_a, double f_a)
{
    ...
    __m128d r;
    r = _mm_loadu_pd((const double *)&r1D[0]);
    _mm_storeu_pd(&b_r1D[0], _mm_div_pd(r, _mm_set1_pd(d)));
    b_r1D[2] = r1D[2] / d;
                      ...
                      double e_a, double f_a)
{
    ...
    __m128d r;
    r = _mm_loadu_pd((const double *)&r1D[3 * (b_r1D - 1)]);
    _mm_storeu_pd(&c_r1D[0], _mm_div_pd(r, _mm_set1_pd(d)));
    ...
    coder::internal::blas::mtimes(c_r1D, j_a, r1);
}
