                            ...
                            double u1)
{
    ...
    do {
        ...
        if (Lcum < L) {
            ...
            //
            u0_tmp = i + k;
            u0 = expl_temp.sp.knots[u0_tmp];
            uk = 0.5 * (expl_temp.sp.knots[u0_tmp] + expl_temp.sp.knots[u0_tmp + 1]);
            ...
            while (std::abs(uk - uk_old) > 1.0E-6) {
                ...
                fk = SplineLengthApprox_Interval1(ctx_q_splines, ctx_cfg_GaussLegendreX,
                                                  ctx_cfg_GaussLegendreW, Curv_sp_index, u0, uk) -
                     Lremain;
