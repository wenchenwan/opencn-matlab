...
static const mxArray *emlrt_marshallOut(const emlrtStack *sp, const CurvStruct *u)
{
    ...
    *(int32_T *)emlrtMxGetData(m21) = u->ConstJerkMaxIterations;
    ...
    emlrtSetFieldR2017b(y, 0, (const char_T *)"Coeff", emlrt_marshallOut(u->Coeff), 21);
    x_y = nullptr;
    m22 = emlrtCreateDoubleScalar(u->a_param);
    emlrtAssign(&x_y, m22);
    emlrtSetFieldR2017b(y, 0, (const char_T *)"a_param", x_y, 22);
    y_y = nullptr;
    m23 = emlrtCreateDoubleScalar(u->b_param);
    emlrtAssign(&y_y, m23);
    emlrtSetFieldR2017b(y, 0, (const char_T *)"b_param", y_y, 23);
    ab_y = nullptr;
    emlrtAssign(&ab_y, emlrtCreateStructMatrix(1, 1, 5, (const char_T **)&b_sv1[0]));
    emlrtSetFieldR2017b(ab_y, 0, (const char_T *)"CoeffX", c_emlrt_marshallOut(u->sp.CoeffX), 0);
    emlrtSetFieldR2017b(ab_y, 0, (const char_T *)"CoeffY", c_emlrt_marshallOut(u->sp.CoeffY), 1);
    emlrtSetFieldR2017b(ab_y, 0, (const char_T *)"CoeffZ", c_emlrt_marshallOut(u->sp.CoeffZ), 2);
    emlrtSetFieldR2017b(ab_y, 0, (const char_T *)"Bl", emlrt_marshallOut(&u->sp.Bl), 3);
    emlrtSetFieldR2017b(ab_y, 0, (const char_T *)"knots", c_emlrt_marshallOut(u->sp.knots), 4);
    emlrtSetFieldR2017b(y, 0, (const char_T *)"sp", ab_y, 24);
    return y;
}
...
static const mxArray *emlrt_marshallOut(const emlrtStack *sp, const FeedoptContext *u)
{
    ...
    *(int32_T *)emlrtMxGetData(m12) = u->programmed_stop;
    ...
    emlrtSetFieldR2017b(y, 0, (const char_T *)"BasisIntegr", emlrt_marshallOut(u->BasisIntegr), 28);
    ...
    *(int32_T *)emlrtMxGetData(m13) = u->Skipped;
    emlrtAssign(&o_y, m13);
    emlrtSetFieldR2017b(y, 0, (const char_T *)"Skipped", o_y, 30);
    return y;
}
                                        ...
                                        const int32_T u_size)
{
    ...
    y = nullptr;
    i = u_size;
    m = emlrtCreateNumericArray(1, &i, mxDOUBLE_CLASS, mxCOMPLEX);
