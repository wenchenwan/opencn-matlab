    ...
    if (!ctx->q_compress.isempty()) {
        ...
        if (Ncrv > 1U) {
            ...
            if (CurvStruct1.zspdmode == ZSpdMode_ZZ) {
                ...
                // EvalCurvStruct(ctx, CurvStruct, 1);
                ...
                if ((r1.size(1) == r2.size(1)) && (i12 == c.size(1))) {
                    int j_loop_ub;
                    ...
                    for (int i13{0}; i13 < 3; i13++) {
                        for (int i14{0}; i14 < j_loop_ub; i14++) {
                            a[i14 + a.size(0) * i13] =
                                (r1[i13 + 3 * i14] + 3.0 * r2[i13 + 3 * i14]) + c[i13 + 3 * i14];
                        }
                    }
                } else {
                ...
                if (r1.size(1) == r2.size(1)) {
                    ...
                    for (int i22{0}; i22 < 3; i22++) {
                        for (int i23{0}; i23 < n_loop_ub; i23++) {
                            a[i23 + a.size(0) * i22] = r1[i22 + 3 * i23] + r2[i22 + 3 * i23];
                        }
                    }
                } else {
                ...
                for (int i30{0}; i30 < s_loop_ub; i30++) {
                    ...
                    double f_varargin_1;
                    double g_varargin_1;
                    e_varargin_1 = r1[3 * i30];
                    r1[3 * i30] = std::pow(e_varargin_1, 2.0);
                    f_varargin_1 = r1[3 * i30 + 1];
                    r1[3 * i30 + 1] = std::pow(f_varargin_1, 2.0);
                    g_varargin_1 = r1[3 * i30 + 2];
                    r1[3 * i30 + 2] = std::pow(g_varargin_1, 2.0);
                }
                coder::sum(r1, x);
                i31 = x.size(1);
