...
void FeedoptDefaultConfig(FeedoptConfig *cfg)
{
    ...
    // 'FeedoptDefaultConfig:21'     );
    // 'FeedoptDefaultConfig:23' if( ~coder.target('MATLAB') )
    // 'FeedoptDefaultConfig:24' coder.cstructname( LP,          StructTypeName.LPCfg );
    // 'FeedoptDefaultConfig:27' machine_off = [0; 0; 0];
    //  mx, my, mz
    // 'FeedoptDefaultConfig:28' piece_off   = [0; 0; -24.8760];
    //  px, py, pz
    // 'FeedoptDefaultConfig:29' tool_off    = [0; 0; 0];
    //  tx, ty, tz
    // 'FeedoptDefaultConfig:30' other_off   = [24.8760; 0; 0];
    //  d1, d2, tool_length
    // 'FeedoptDefaultConfig:33' kin_params = [machine_off, piece_off, tool_off, other_off];
    // 'FeedoptDefaultConfig:35' cfg = struct(...
    // 'FeedoptDefaultConfig:36'     'maskTot',  logical( [ 1, 1, 1, 0, 1, 1 ] ),... % [X,Y,Z,A,B,C]
    // 'FeedoptDefaultConfig:37'     'maskCart', logical( 0 ),...                    % Do not modify
    // 'FeedoptDefaultConfig:38'     'maskRot',  logical( 0 ),...                    % Do not modify
    // 'FeedoptDefaultConfig:39'     'indCart', int32( 0 ), ...                      % Do not modify
    // 'FeedoptDefaultConfig:40'     'indRot',  int32( 0 ),...                       % Do not modify
    // 'FeedoptDefaultConfig:41'     'NumberAxis', int32( 0 ), ...                   % Do not modify
    // 'FeedoptDefaultConfig:42'     'NCart',   int32( 0 ), ...                      % Do not modify
    // 'FeedoptDefaultConfig:43'     'NRot',    int32( 0 ), ...                      % Do not modify
    // 'FeedoptDefaultConfig:44'     'D', 0, ...                                     % Do not modify
    // 'FeedoptDefaultConfig:45'     'coeffD', 1, ...                                % Coefficient
    // between cartésian and rotativ axis 'FeedoptDefaultConfig:46'     'kin_params', reshape(
    // kin_params, [], 1 ), ... 'FeedoptDefaultConfig:47'     'kin_type', 'xyzbc', ...
    // 'FeedoptDefaultConfig:48'     'NDiscr', int32( 20 ),...
    // 'FeedoptDefaultConfig:49'     'NBreak', int32( 10 ),...
    // 'FeedoptDefaultConfig:50'     'UseDynamicBreakpoints',false,...       % Use a variable number
    // of breakpoints for different lengths 'FeedoptDefaultConfig:51'
    // 'UseLinearBreakpoints',false,...        % Use a linear distribution of breakpoints (else
    // sinspace) 'FeedoptDefaultConfig:52'     'DynamicBreakpointsDistance', 0.1,...   % Distance
    // between two breakpoints in mm 'FeedoptDefaultConfig:53'     'NHorz', int32( 10 ),...
    // 'FeedoptDefaultConfig:54'     'fmax', 1000,...
    // 'FeedoptDefaultConfig:55'     'smax', 75000,...
    // 'FeedoptDefaultConfig:56'     'vmax', [500,500,800,0, 40,50],... %[mm] [rad]
    // 'FeedoptDefaultConfig:57'     'amax', [15000,15000,15000,0, 200,1000],...
    // 'FeedoptDefaultConfig:58'     'jmax', [750000,750000,3000000,0,10000,50000],...
    // 'FeedoptDefaultConfig:59'     'LeeSplineDegree', int32( 4 ),...
    // 'FeedoptDefaultConfig:60'     'SplineDegree',    int32( 3 ),...
    // 'FeedoptDefaultConfig:61'     'CutOff', 1E-3,...
    // 'FeedoptDefaultConfig:62'     'LSplit',  3,...
    // 'FeedoptDefaultConfig:63'     'LSplitZero', 1E-1,...
    // 'FeedoptDefaultConfig:64'     'LThresholdMax', 5.0,...
    ...
    // 'FeedoptDefaultConfig:69'     'ZeroStartAccLimit', 0.01, ...
    // 'FeedoptDefaultConfig:70'     'ZeroStartJerkLimit', 1E6, ...
    // 'FeedoptDefaultConfig:71'     'ZeroStartVelLimit', 0.5, ...
    // 'FeedoptDefaultConfig:72'     'source', repmat(char(0), [1, 1024]),...
    // 'FeedoptDefaultConfig:73'     'DebugCutZero', false,...
    // 'FeedoptDefaultConfig:74'     'Cusp', ...
    // 'FeedoptDefaultConfig:75'     struct(...
    // 'FeedoptDefaultConfig:76'         'Skip', false,...
    // 'FeedoptDefaultConfig:77'         'CuspThreshold', 50 ...
    // 'FeedoptDefaultConfig:78'     ),...
    // 'FeedoptDefaultConfig:79'     'Compressing', ...
    // 'FeedoptDefaultConfig:80'     struct(...
    // 'FeedoptDefaultConfig:81'         'Skip', false,...
    // 'FeedoptDefaultConfig:82'         'ColTolCosLee',     cosd(tol_col_compress_deg) ...
    // 'FeedoptDefaultConfig:83'     ),...
    // 'FeedoptDefaultConfig:84'     'Smoothing', ...
    // 'FeedoptDefaultConfig:85'     struct( ...
    // 'FeedoptDefaultConfig:86'         'Skip', false,...
    // 'FeedoptDefaultConfig:87'         'ColTolCosSmooth',  cosd(tol_col_smooth_deg), ...
    // 'FeedoptDefaultConfig:88'         'ColTolSmooth',     1E-5 ...
    // 'FeedoptDefaultConfig:89'     ),...
    // 'FeedoptDefaultConfig:90'     'GaussLegendreN', GaussLegendreN, ...
    // 'FeedoptDefaultConfig:91'     'GaussLegendreX', GaussLegendreX, ...
    // 'FeedoptDefaultConfig:92'     'GaussLegendreW', GaussLegendreW, ...
    // 'FeedoptDefaultConfig:93'     'opt', LP,...
    // 'FeedoptDefaultConfig:94'     'LogFileName', 'logs/logs');
    ...
    //  %[mm] [rad]
    // 'FeedoptDefaultConfig:96' coder.varsize( 'cfg.indCart',   StructTypeName.dimInd{ : } );
    // 'FeedoptDefaultConfig:97' coder.varsize( 'cfg.indRot',    StructTypeName.dimInd{ : } );
    // 'FeedoptDefaultConfig:98' coder.varsize( 'cfg.maskTot',   StructTypeName.dimMask{ : } );
    // 'FeedoptDefaultConfig:99' coder.varsize( 'cfg.maskCart',  StructTypeName.dimMask{ : } );
    // 'FeedoptDefaultConfig:100' coder.varsize( 'cfg.maskRot',   StructTypeName.dimMask{ : } );
    // 'FeedoptDefaultConfig:101' coder.varsize( 'cfg.D',         StructTypeName.dimD{ : } );
    // 'FeedoptDefaultConfig:102' coder.varsize( 'cfg.kin_params',StructTypeName.dimKinParams{ : }
    // ); 'FeedoptDefaultConfig:103' coder.cstructname( cfg,         StructTypeName.FeedoptCfg );
    // 'FeedoptDefaultConfig:105' [ cfg ] = setMachineAxisInConfig( cfg, cfg.maskTot );
    r.maskTot.size[0] = 1;
    r.maskTot.size[1] = 6;
    for (int i{0}; i < 6; i++) {
