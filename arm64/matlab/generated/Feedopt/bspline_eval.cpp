                  ...
                  double *xd, double *xdd, double *xddd)
{
    ...
    // 'bspline_eval:19' coder.updateBuildInfo('addSourceFiles','c_spline.c', '$(START_DIR)/src');
    // 'bspline_eval:20' coder.updateBuildInfo('addLinkFlags', LibInfo.gsl.lflags);
    // 'bspline_eval:21' coder.cinclude('src/c_spline.h');
