...
//
// Arguments    : CurvStruct *splineCurve
...
//
namespace ocn {
void binary_expand_op(CurvStruct *splineCurve, const ::coder::array<double, 2U> &y, int i4, int i5,
                      int i6, int i7)
{
    int i;
    int i1;
    ...
    splineCurve->sp.Lk.set_size(1, i1);
    ...
    for (int i3{0}; i3 < loop_ub; i3++) {
        splineCurve->sp.Lk[i3] = y[i3 * stride_0_1] *
                                 (splineCurve->sp.knots[(i4 + i5) + i3 * stride_1_1] -
                                  splineCurve->sp.knots[i4 + i3 * stride_2_1]) /
                                 2.0;
    }
}
