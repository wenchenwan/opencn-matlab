            ...
            while ((count < 1000) && (std::abs(fk) > 1.0E-7)) {
                ...
                for (int i23{0}; i23 < 5; i23++) {
                    for (int i24{0}; i24 < o_loop_ub; i24++) {
                        double d_varargin_1;
                        d_varargin_1 = b_r1D[i24 + b_r1D.size(0) * i23];
                        r1[i24 + r1.size(0) * i23] = std::pow(d_varargin_1, 2.0);
                    }
                }
                coder::sum(r1, r1Dnorm);
                // 'mysqrt:3' y = sqrt(x);
    ...
    if (b_L <= L) {
        ...
        if (d_expl_temp < curv->b_param) {
            ...
            for (int i15{0}; i15 < 5; i15++) {
                double d;
                d = ctx_cfg_GaussLegendreX[i15];
                e_expl_temp[i15] = (d_expl_temp * (1.0 - d) + curv->b_param * (d + 1.0)) / 2.0;
            }
            ...
            for (int i18{0}; i18 < 5; i18++) {
                for (int i19{0}; i19 < l_loop_ub; i19++) {
                    double c_varargin_1;
                    c_varargin_1 = b_r1D[i19 + b_r1D.size(0) * i18];
        ...
        if (LkEndVec_size[1] == 0) {
            ...
            while ((count < 1000) && (std::abs(fk) > 1.0E-7)) {
                ...
                for (int i20{0}; i20 < 5; i20++) {
                    double d2;
                    d2 = ctx_cfg_GaussLegendreX[i20];
                    uStart[i20] = (uStart_tmp * (1.0 - d2) + uMiddle * (d2 + 1.0)) / 2.0;
                }
                ...
                for (int i21{0}; i21 < 5; i21++) {
                    for (int i22{0}; i22 < m_loop_ub; i22++) {
                        ...
                        r1[i22 + r1.size(0) * i21] = std::pow(d_varargin_1, 2.0);
                    }
                }
                coder::sum(r1, r1Dnorm);
                // 'mysqrt:3' y = sqrt(x);
