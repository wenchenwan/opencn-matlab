...
// Arguments    : double dt
//                double zeroStopTime
//                ResampleStateClass *b_state
// Return Type  : void
//
namespace ocn {
void ResampleState(double dt, double zeroStopTime, ResampleStateClass *b_state)
{
    ...
    b_state->zeroStopTime = static_cast<int>(std::round(zeroStopTime));
