                ...
                if ((curv.Info.zspdmode == ZSpdMode_NZ) || (curv.Info.zspdmode == ZSpdMode_ZZ)) {
                    ...
                    while (searchJps) {
                        ...
                        for (int i24{0}; i24 < s_loop_ub; i24++) {
                            double c_varargin_1;
                            c_varargin_1 = ud[i24];
                            r1[i24] = std::pow(c_varargin_1, 2.0);
                        }
                        if (r2D.size(1) == 1) {
                            i26 = r1.size(1);
                        } else {
                        ...
                        for (int i29{0}; i29 < v_loop_ub; i29++) {
                            double d_varargin_1;
                            d_varargin_1 = ud[i29];
                            r1[i29] = std::pow(d_varargin_1, 3.0);
                        }
                        if (r2D.size(1) == 1) {
                            i31 = ud.size(1);
                        } else {
                        ...
                        coder::vecnorm(f_r1D, r1);
                        if (r1.size(1) == ud.size(1)) {
                            int eb_loop_ub;
                            feed.set_size(1, r1.size(1));
                            eb_loop_ub = r1.size(1);
                            for (int i49{0}; i49 < eb_loop_ub; i49++) {
                                feed[i49] = r1[i49] * ud[i49];
                            }
                        } else {
                            times(feed, r1, ud);
                        }
                        ...
                        if (b_y) {
                            ...
                            r3.set_size(e_trueCount, r2.size(1));
                            stride_0_0 = (r2.size(0) != 1);
                            stride_1_0 = (b_trueCount != 1);
                            hb_loop_ub = r2.size(1);
                            for (int i54{0}; i54 < hb_loop_ub; i54++) {
                                ...
                                for (int i55{0}; i55 < ib_loop_ub; i55++) {
                                    r3[i55 + r3.size(0) * i54] =
                                        (r2[i55 * stride_0_0 + r2.size(0) * i54] >
                            ...
                            h_k = 0;
                            exitg1 = false;
                            while ((!exitg1) && (h_k <= r3.size(0) * r3.size(1) - 1)) {
                                if (r3[h_k]) {
                                    c_y = true;
                                    exitg1 = true;
                                } else {
                            ...
                            if (c_y) {
                                ...
                                // 'all' );
                                if (r2.size(0) == b_trueCount) {
                                    int jb_loop_ub;
                                    int lb_loop_ub;
                                    r4.set_size(r2.size(0), r2.size(1));
                                    jb_loop_ub = r2.size(1);
                                    for (int i58{0}; i58 < jb_loop_ub; i58++) {
                                        int kb_loop_ub;
                                        kb_loop_ub = r2.size(0);
                                        for (int i59{0}; i59 < kb_loop_ub; i59++) {
                                            r4[i59 + r4.size(0) * i58] =
                                                r2[i59 + r2.size(0) * i58] - vmax_data[i59];
                                        }
                                    }
                                    r2.set_size(r4.size(0), r4.size(1));
                                    lb_loop_ub = r4.size(1);
                                    for (int i60{0}; i60 < lb_loop_ub; i60++) {
                                        int nb_loop_ub;
                                        nb_loop_ub = r4.size(0);
                                        for (int i62{0}; i62 < nb_loop_ub; i62++) {
                                            r2[i62 + r2.size(0) * i60] = r4[i62 + r4.size(0) * i60];
                                        }
                                    }
                                    coder::internal::b_maximum(r2, &v_delta, &b_iindx);
                                } else {
                                    binary_expand_op(r2, vmax_data, &b_trueCount, &v_delta,
                                                     &b_iindx);
                                }
                                ...
                                if ((A.size(0) != 0) && (A.size(1) != 0)) {
                                    ...
                                    for (int i_k{0}; i_k < i56; i_k++) {
                                        ...
                                        for (int j_k{0}; j_k < i57; j_k++) {
                                            r2[j_k + r2.size(0) * i_k] =
                                                std::abs(A[j_k + A.size(0) * i_k]);
                                        }
                                    }
                                }
                                if (c_trueCount == 1) {
                                    f_trueCount = r2.size(0);
                                } else {
                                    f_trueCount = c_trueCount;
                                }
                                r3.set_size(f_trueCount, r2.size(1));
                                b_stride_0_0 = (r2.size(0) != 1);
                                ...
                                for (int i61{0}; i61 < mb_loop_ub; i61++) {
                                    ...
                                    for (int i63{0}; i63 < ob_loop_ub; i63++) {
                                        r3[i63 + r3.size(0) * i61] =
                                            (r2[i63 * b_stride_0_0 + r2.size(0) * i61] >
                                ...
                                k_k = 0;
                                exitg1 = false;
                                while ((!exitg1) && (k_k <= r3.size(0) * r3.size(1) - 1)) {
                                    if (r3[k_k]) {
                                        d_y = true;
                                        exitg1 = true;
                                    } else {
                                ...
                                if (d_y) {
                                    ...
                                    if (r2.size(0) == c_trueCount) {
                                        ...
                                        pb_loop_ub = r2.size(1);
                                        for (int i66{0}; i66 < pb_loop_ub; i66++) {
                                            int qb_loop_ub;
                                            qb_loop_ub = r2.size(0);
                                            for (int i67{0}; i67 < qb_loop_ub; i67++) {
                                                r5[i67 + r5.size(0) * i66] =
                                                    r2[i67 + r2.size(0) * i66] - amax_data[i67];
                                            }
                                        }
                                        r2.set_size(r5.size(0), r5.size(1));
                                        rb_loop_ub = r5.size(1);
                                        for (int i68{0}; i68 < rb_loop_ub; i68++) {
                                            int tb_loop_ub;
                                            tb_loop_ub = r5.size(0);
                                            for (int i70{0}; i70 < tb_loop_ub; i70++) {
                                                r2[i70 + r2.size(0) * i68] =
                                                    r5[i70 + r5.size(0) * i68];
                                            }
                                        }
                                        coder::internal::b_maximum(r2, &a_delta, &c_iindx);
                                    } else {
                                        binary_expand_op(r2, amax_data, &c_trueCount, &a_delta,
                                                         &c_iindx);
                                    }
                                    ...
                                    int sb_loop_ub;
                                    bool e_y;
                                    r2.set_size(c_J.size(0), c_J.size(1));
                                    if ((c_J.size(0) != 0) && (c_J.size(1) != 0)) {
                                        ...
                                        for (int l_k{0}; l_k < i64; l_k++) {
                                            ...
                                            for (int m_k{0}; m_k < i65; m_k++) {
                                                r2[m_k + r2.size(0) * l_k] =
                                                    std::abs(c_J[m_k + c_J.size(0) * l_k]);
                                            }
                                        }
                                    }
                                    if (d_trueCount == 1) {
                                        g_trueCount = r2.size(0);
                                    } else {
                                        g_trueCount = d_trueCount;
                                    }
                                    r3.set_size(g_trueCount, r2.size(1));
                                    c_stride_0_0 = (r2.size(0) != 1);
                                    ...
                                    for (int i69{0}; i69 < sb_loop_ub; i69++) {
                                        ...
                                        for (int i71{0}; i71 < ub_loop_ub; i71++) {
                                            r3[i71 + r3.size(0) * i69] =
                                                (r2[i71 * c_stride_0_0 + r2.size(0) * i69] >
                                    ...
                                    n_k = 0;
                                    exitg1 = false;
                                    while ((!exitg1) && (n_k <= r3.size(0) * r3.size(1) - 1)) {
                                        if (r3[n_k]) {
                                            e_y = true;
                                            exitg1 = true;
                                        } else {
                                    ...
                                    if (e_y) {
                                        ...
                                        if (r2.size(0) == d_trueCount) {
                                            int vb_loop_ub;
                                            int xb_loop_ub;
                                            r6.set_size(r2.size(0), r2.size(1));
                                            vb_loop_ub = r2.size(1);
                                            for (int i72{0}; i72 < vb_loop_ub; i72++) {
                                                int wb_loop_ub;
                                                wb_loop_ub = r2.size(0);
                                                for (int i73{0}; i73 < wb_loop_ub; i73++) {
                                                    r6[i73 + r6.size(0) * i72] =
                                                        r2[i73 + r2.size(0) * i72] - jmax_data[i73];
                                                }
                                            }
                                            r2.set_size(r6.size(0), r6.size(1));
                                            xb_loop_ub = r6.size(1);
                                            for (int i74{0}; i74 < xb_loop_ub; i74++) {
                                                int yb_loop_ub;
                                                yb_loop_ub = r6.size(0);
                                                for (int i75{0}; i75 < yb_loop_ub; i75++) {
                                                    r2[i75 + r2.size(0) * i74] =
                                                        r6[i75 + r6.size(0) * i74];
                                                }
                                            }
                                            coder::internal::b_maximum(r2, &j_delta, &d_iindx);
                                        } else {
                                            binary_expand_op(r2, jmax_data, &d_trueCount, &j_delta,
                                                             &d_iindx);
                                        }
