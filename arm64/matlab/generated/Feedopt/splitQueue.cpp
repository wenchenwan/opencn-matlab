                    ...
                    if (ret < 0.0) {
                        ...
                        for (int b_j{0}; b_j < 3; b_j++) {
                            ...
                            for (int i21{0}; i21 < 2; i21++) {
                                for (int i24{0}; i24 < trueCount; i24++) {
                                    rd_data[(i24 + trueCount * i21) + trueCount * 2 * b_j] =
                                        b_rd_data[i24 + trueCount * i21];
                                }
                                for (int i27{0}; i27 <= rdd; i27++) {
                                    b_rdd_data[i27 + trueCount * i21] =
                                        rdd_data[(i27 + trueCount * i21) + trueCount * 2 * b_j] / c;
                                }
                            }
                            for (int i23{0}; i23 < 2; i23++) {
                                for (int i26{0}; i26 < trueCount; i26++) {
                                    rdd_data[(i26 + trueCount * i23) + trueCount * 2 * b_j] =
                                        b_rdd_data[i26 + trueCount * i23];
                                }
                            }
                        }
                        ...
                        for (int c_j{0}; c_j < 3; c_j++) {
                            ...
                            for (int i20{0}; i20 < trueCount; i20++) {
                                c_x[i20] = r_data[(i20 + trueCount * (ind1[1][c_j] - 1)) +
                                                  trueCount * 2 * (ind1[0][c_j] - 1)] -
                                           r_data[(i20 + trueCount * (ind2[1][c_j] - 1)) +
                                                  trueCount * 2 * (ind2[0][c_j] - 1)];
                            }
                            ...
                            for (int i25{0}; i25 < trueCount; i25++) {
                                c_x[i25] = rd_data[(i25 + trueCount * (ind1[1][c_j] - 1)) +
                                                   trueCount * 2 * (ind1[0][c_j] - 1)] -
                                           rd_data[(i25 + trueCount * (ind2[1][c_j] - 1)) +
                                                   trueCount * 2 * (ind2[0][c_j] - 1)];
                            }
                            ...
                            c_x.set_size(trueCount);
                            for (int i29{0}; i29 < trueCount; i29++) {
                                c_x[i29] = rdd_data[(i29 + trueCount * (ind1[1][c_j] - 1)) +
                                                    trueCount * 2 * (ind1[0][c_j] - 1)] -
                                           rdd_data[(i29 + trueCount * (ind2[1][c_j] - 1)) +
                                                    trueCount * 2 * (ind2[0][c_j] - 1)];
                            }
