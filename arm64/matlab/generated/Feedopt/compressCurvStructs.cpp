                    ...
                    if (pvec.size(1) > 2) {
                        ...
                        for (int j{0}; j < i25; j++) {
                            ...
                            for (int k_k{0}; k_k < i36; k_k++) {
                                ...
                                bspline_eval(splineCurve.sp.Bl.handle, b_splineCurve, &r2[k_k], &d,
                                             &d1, &d2);
                                r6[k_k] = d2;
                                r5[k_k] = d1;
                                r4[k_k] = d;
                        ...
                        r3.set_size(r1D.size(0), r1D.size(1));
                        ...
                        for (int i27{0}; i27 < j_loop_ub; i27++) {
                            ...
                            for (int i30{0}; i30 < k_loop_ub; i30++) {
                                ...
                                r3[i30 + r3.size(0) * i27] = std::pow(c_varargin_1, 2.0);
                            }
                        }
                        coder::sum(r3, x);
                        i29 = x.size(1);
