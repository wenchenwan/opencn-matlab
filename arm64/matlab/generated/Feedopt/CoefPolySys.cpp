                 ...
                 const double in7[3], double kappa1, double CoefPS[16])
{
    ...
    d70 = in1[2] * in2[2];
    d71 = d70 * t3;
    q_CoefPS_tmp = in5[0] * in2[0];
    r_CoefPS_tmp = in5[1] * in2[1];
    s_CoefPS_tmp = q_CoefPS_tmp * t2;
    t_CoefPS_tmp = q_CoefPS_tmp * t3;
    u_CoefPS_tmp = d69 * in2[2];
    v_CoefPS_tmp = in5[2] * in2[2];
    w_CoefPS_tmp = q_CoefPS_tmp * t4;
    x_CoefPS_tmp = r_CoefPS_tmp * t2;
    y_CoefPS_tmp = v_CoefPS_tmp * t3;
    ab_CoefPS_tmp = r_CoefPS_tmp * t3;
    bb_CoefPS_tmp = v_CoefPS_tmp * t4;
    cb_CoefPS_tmp = r_CoefPS_tmp * t4;
    db_CoefPS_tmp = in1[2] * in6[2];
    eb_CoefPS_tmp = in1[0] * in6[0];
    fb_CoefPS_tmp = in1[1] * in6[1];
    gb_CoefPS_tmp = in5[2] * in6[2];
    hb_CoefPS_tmp = in5[0] * in6[0];
    ib_CoefPS_tmp = in5[1] * in6[1];
    jb_CoefPS_tmp = in5[2] * t3;
    CoefPS[7] = t201 * (((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((in1[0] * t83_tmp * in6[0] * 80.0 + in1[0] * t86_tmp * in6[0] * 200.0) + in1[0] * t91_tmp * in6[0] * 200.0) + in1[1] * t83_tmp * in6[1] * 200.0) + in1[1] * t86_tmp * in6[1] * 80.0) + in1[1] * t91_tmp * in6[1] * 200.0) + d48 * in6[2] * 200.0) + in1[2] * t86_tmp * in6[2] * 200.0) + in1[2] * t91_tmp * in6[2] * 80.0) - in5[0] * t83_tmp * in6[0] * 80.0) - in5[0] * t86_tmp * in6[0] * 200.0) - in5[0] * t91_tmp * in6[0] * 200.0) - in5[1] * t83_tmp * in6[1] * 200.0) - in5[1] * t86_tmp * in6[1] * 80.0) - in5[1] * t91_tmp * in6[1] * 200.0) - d61 * in6[2] * 200.0) - in5[2] * t86_tmp * in6[2] * 200.0) - in5[2] * t91_tmp * in6[2] * 80.0) + in1[0] * t16 * t24 * 180.0) + in1[1] * t14 * t27 * 180.0) + in1[0] * t19 * t24 * 180.0) + in1[2] * t14 * t30 * 180.0) + in1[1] * t19 * t27 * 180.0) + in1[2] * t16 * t30 * 180.0) - in5[0] * t16 * t24 * 180.0) - in5[1] * t14 * t27 * 180.0) - in5[0] * t19 * t24 * 180.0) - in5[2] * t14 * t30 * 180.0) - in5[1] * t19 * t27 * 180.0) - in5[2] * t16 * t30 * 180.0) - d49 * t3 * in6[0] * 80.0) - d49 * t4 * in6[0] * 80.0) + d64 * t4 * in6[0] * 40.0) - d50 * t3 * in6[1] * 80.0) + d50 * t4 * in6[1] * 40.0) - d65 * t4 * in6[1] * 80.0) + d51 * t3 * in6[2] * 40.0) - d51 * t4 * in6[2] * 80.0) - d66 * t4 * in6[2] * 80.0) + d52 * t3 * in6[0] * 80.0) + d52 * t4 * in6[0] * 80.0) + d56 * t25 * 60.0) - d58 * t23 * 120.0) - d67 * t4 * in6[0] * 40.0) + d55 * t3 * in6[1] * 80.0) - d62 * t25 * 120.0) + d59 * t23 * 60.0) - d55 * t4 * in6[1] * 40.0) - d57 * t25 * 120.0) - d60 * t23 * 120.0) - d63 * t23 * 120.0) + d68 * t4 * in6[1] * 80.0) - d69 * t3 * in6[2] * 40.0) + d56 * t28 * 60.0) - d71 * t23 * 120.0) + d69 * t4 * in6[2] * 80.0) - d62 * t28 * 120.0) - d63 * t25 * 120.0) + in1[2] * in2[2] * t4 * t23 * 60.0) + jb_CoefPS_tmp * t4 * in6[2] * 80.0) - d57 * t28 * 120.0) - d58 * t28 * 120.0) - d71 * t25 * 120.0) + d59 * t28 * 60.0) + in1[2] * in2[2] * t4 * t25 * 60.0) - d60 * t28 * 120.0) - s_CoefPS_tmp * t25 * 60.0) + x_CoefPS_tmp * t23 * 120.0) + t_CoefPS_tmp * t25 * 120.0) - ab_CoefPS_tmp * t23 * 60.0) + w_CoefPS_tmp * t25 * 120.0) + cb_CoefPS_tmp * t23 * 120.0) + u_CoefPS_tmp * t23 * 120.0) - s_CoefPS_tmp * t28 * 60.0) + y_CoefPS_tmp * t23 * 120.0) + t_CoefPS_tmp * t28 * 120.0) + u_CoefPS_tmp * t25 * 120.0) - bb_CoefPS_tmp * t23 * 60.0) + w_CoefPS_tmp * t28 * 120.0) + x_CoefPS_tmp * t28 * 120.0) + y_CoefPS_tmp * t25 * 120.0) - ab_CoefPS_tmp * t28 * 60.0) - bb_CoefPS_tmp * t25 * 60.0) + cb_CoefPS_tmp * t28 * 120.0) + db_CoefPS_tmp * t14 * t25 * 180.0) + db_CoefPS_tmp * t16 * t23 * 180.0) + eb_CoefPS_tmp * t16 * t28 * 180.0) + eb_CoefPS_tmp * t19 * t25 * 180.0) + fb_CoefPS_tmp * t14 * t28 * 180.0) + fb_CoefPS_tmp * t19 * t23 * 180.0) - gb_CoefPS_tmp * t14 * t25 * 180.0) - gb_CoefPS_tmp * t16 * t23 * 180.0) - hb_CoefPS_tmp * t16 * t28 * 180.0) - hb_CoefPS_tmp * t19 * t25 * 180.0) - ib_CoefPS_tmp * t14 * t28 * 180.0) - ib_CoefPS_tmp * t19 * t23 * 180.0) * 6.0;
    CoefPS[8] = t205;
    ...
    d108 = d80 * in1[2];
    kb_CoefPS_tmp = d82 * in1[1] * in2[1];
    g_CoefPS_tmp_tmp = d78 * in5[1];
    lb_CoefPS_tmp = g_CoefPS_tmp_tmp * in2[1];
    mb_CoefPS_tmp = d80 * in5[0] * in2[0];
    nb_CoefPS_tmp = d78 * in5[2];
    ob_CoefPS_tmp = d82 * in5[0] * in2[0];
    pb_CoefPS_tmp = nb_CoefPS_tmp * in2[2];
    qb_CoefPS_tmp = d80 * in5[2];
    rb_CoefPS_tmp = d82 * in5[1] * in2[1];
    sb_CoefPS_tmp = qb_CoefPS_tmp * in2[2];
    tb_CoefPS_tmp = d79 * t2;
    ub_CoefPS_tmp = d106 * in2[2];
    CoefPS[14] = t201 * ((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((t17 * t25 * 72.0 + t20 * t23 * 72.0) + t17 * t28 * 72.0) + t22 * t23 * 72.0) + t22 * t25 * 72.0) + t20 * t28 * 72.0) + t83_tmp * t14 * 40.0) + t86_tmp * t14 * 112.0) + t83_tmp * t16 * 112.0) + t91_tmp * t14 * 112.0) + t86_tmp * t16 * 40.0) + t91_tmp * t16 * 112.0) + t83_tmp * t19 * 112.0) + t86_tmp * t19 * 112.0) + t91_tmp * t19 * 40.0) - t201_tmp * t14 * 64.0) - b_t201_tmp * t14 * 64.0) - t201_tmp * t16 * 64.0) - c_t201_tmp * t14 * 64.0) - b_t201_tmp * t16 * 64.0) - c_t201_tmp * t16 * 64.0) - t201_tmp * t19 * 64.0) - b_t201_tmp * t19 * 64.0) - c_t201_tmp * t19 * 64.0) + t14 * t16 * t28 * 144.0) + t14 * t19 * t25 * 144.0) + t16 * t19 * t23 * 144.0) - kappa0 * in1[0] * in6[0] * t33 * 120.0) - kappa0 * in1[1] * in6[1] * t32 * 120.0) - d72 * t35 * 120.0) + d72 * t36 * 60.0) + d73 * t34 * 60.0) + d74 * t32 * 60.0) + d72 * t37 * 60.0) + d73 * t35 * 60.0) + d74 * t33 * 60.0) - d74 * t34 * 120.0) - d73 * t37 * 120.0) - d74 * t36 * 120.0) + d75 * t33 * 120.0) + d76 * t32 * 120.0) + d75 * t35 * 120.0) - d75 * t36 * 60.0) - d76 * t34 * 60.0) - d77 * t32 * 60.0) - d72 * t47 * 60.0) - d73 * t45 * 60.0) - d75 * t37 * 60.0) - d76 * t35 * 60.0) - d77 * t33 * 60.0) - d74 * t44 * 60.0) + d77 * t34 * 120.0) - d72 * t49 * 60.0) + d76 * t37 * 120.0) - d73 * t48 * 60.0) - d74 * t46 * 60.0) + d77 * t36 * 120.0) + d75 * t47 * 60.0) + d76 * t45 * 60.0) + d77 * t44 * 60.0) + d75 * t49 * 60.0) + d76 * t48 * 60.0) + d77 * t46 * 60.0) + d79 * t86_tmp * 160.0) + d79 * t91_tmp * 160.0) + d81 * t83_tmp * 160.0) + d81 * t91_tmp * 160.0) + d83 * t83_tmp * 160.0) + d83 * t86_tmp * 160.0) - d84 * t86_tmp * 160.0) - d84 * t91_tmp * 160.0) - d85 * t83_tmp * 160.0) - d85 * t91_tmp * 160.0) - d86 * t83_tmp * 160.0) - d86 * t86_tmp * 160.0) + tb_CoefPS_tmp * t3 * 40.0) + tb_CoefPS_tmp * t4 * 40.0) - d79 * t3 * t4 * 40.0) + d80 * in1[1] * t2 * t3 * 40.0) - d80 * in1[1] * t2 * t4 * 40.0) + d81 * t3 * t4 * 40.0) - d87 * t3 * 40.0) + d87 * t4 * 40.0) + d83 * t3 * t4 * 40.0) - d88 * t3 * 40.0) - d88 * t4 * 40.0) + d84 * t3 * t4 * 40.0) - d89 * t3 * 40.0) + d89 * t4 * 40.0) - d85 * t3 * t4 * 40.0) + d90 * t3 * 40.0) - d90 * t4 * 40.0) - d86 * t3 * t4 * 40.0) + d91 * t23 * 120.0) + d93 * t25 * 120.0) + d92 * t23 * 120.0) + d95 * t25 * 180.0) + d96 * t23 * 180.0) + d91 * t28 * 180.0) + d92 * t25 * 180.0) + d93 * t28 * 180.0) + d94 * t23 * 180.0) + d94 * t25 * 120.0) + d95 * t28 * 120.0) + d96 * t28 * 120.0) - d97 * t23 * 120.0) - d99 * t25 * 120.0) - d98 * t23 * 120.0) - d101 * t25 * 180.0) - d102 * t23 * 180.0) - d97 * t28 * 180.0) - d98 * t25 * 180.0) - d99 * t28 * 180.0) - d100 * t23 * 180.0) - d100 * t25 * 120.0) - d101 * t28 * 120.0) - d102 * t28 * 120.0) - d104 * t2 * in6[0] * 160.0) - d105 * t2 * in6[1] * 40.0) - d104 * t3 * in6[0] * 40.0) - d105 * t3 * in6[1] * 160.0) + d104 * t4 * in6[0] * 20.0) - d106 * t2 * in2[2] * in6[0] * 160.0) + d105 * t4 * in6[1] * 20.0) - d107 * t2 * in6[2] * 40.0) + ub_CoefPS_tmp * t3 * in6[0] * 20.0) + d107 * t3 * in6[2] * 20.0) - ub_CoefPS_tmp * t4 * in6[0] * 40.0) + d108 * t2 * in2[2] * in6[1] * 20.0) - d82 * in1[0] * in2[0] * t4 * in6[2] * 160.0) + d82 * in1[1] * in2[1] * t2 * in6[2] * 20.0) - d80 * in1[2] * in2[2] * t3 * in6[1] * 160.0) - kb_CoefPS_tmp * t3 * in6[2] * 40.0) - d108 * in2[2] * t4 * in6[1] * 40.0) - kb_CoefPS_tmp * t4 * in6[2] * 160.0) + lb_CoefPS_tmp * t2 * in6[0] * 160.0) + mb_CoefPS_tmp * t2 * in6[1] * 40.0) + lb_CoefPS_tmp * t3 * in6[0] * 40.0) + mb_CoefPS_tmp * t3 * in6[1] * 160.0) - lb_CoefPS_tmp * t4 * in6[0] * 20.0) + nb_CoefPS_tmp * t2 * in2[2] * in6[0] * 160.0) - mb_CoefPS_tmp * t4 * in6[1] * 20.0) + ob_CoefPS_tmp * t2 * in6[2] * 40.0) - pb_CoefPS_tmp * t3 * in6[0] * 20.0) - ob_CoefPS_tmp * t3 * in6[2] * 20.0) + pb_CoefPS_tmp * t4 * in6[0] * 40.0) - qb_CoefPS_tmp * t2 * in2[2] * in6[1] * 20.0) + ob_CoefPS_tmp * t4 * in6[2] * 160.0) - rb_CoefPS_tmp * t2 * in6[2] * 20.0) - d106 * in2[0] * in2[2] * t25 * 180.0) - d108 * in2[1] * in2[2] * t23 * 180.0) + sb_CoefPS_tmp * t3 * in6[1] * 160.0) - d107 * in2[2] * t25 * 180.0) - kb_CoefPS_tmp * in2[2] * t23 * 180.0) + rb_CoefPS_tmp * t3 * in6[2] * 40.0) - d103 * in2[0] * in2[1] * t28 * 180.0) - d105 * in2[1] * t28 * 180.0) + sb_CoefPS_tmp * t4 * in6[1] * 40.0) + rb_CoefPS_tmp * t4 * in6[2] * 160.0) + nb_CoefPS_tmp * in2[0] * in2[2] * t25 * 180.0) + qb_CoefPS_tmp * in2[1] * in2[2] * t23 * 180.0) + ob_CoefPS_tmp * in2[2] * t25 * 180.0) + rb_CoefPS_tmp * in2[2] * t23 * 180.0) + g_CoefPS_tmp_tmp * in2[0] * in2[1] * t28 * 180.0) + mb_CoefPS_tmp * in2[1] * t28 * 180.0) * -6.0;
    d109 = in1[0] * t15;
    d110 = in1[1] * t18;
    d111 = in1[2] * t21;
    d112 = in5[0] * t15;
    ...
    d118 = in1[0] * t4 * in6[0];
    d119 = in1[1] * t4 * in6[1];
    vb_CoefPS_tmp = in1[2] * t4 * in6[2];
    wb_CoefPS_tmp = d52 * in6[0];
    xb_CoefPS_tmp = d67 * in6[0];
    yb_CoefPS_tmp = d69 * in6[2];
    ac_CoefPS_tmp = in5[0] * t4 * in6[0];
    bc_CoefPS_tmp = d55 * in6[1];
    cc_CoefPS_tmp = jb_CoefPS_tmp * in6[2];
    dc_CoefPS_tmp = d68 * in6[1];
    ec_CoefPS_tmp = in5[2] * t4 * in6[2];
    fc_CoefPS_tmp = in5[1] * t4 * in6[1];
    gc_CoefPS_tmp = d64 * in6[0];
    CoefPS[15] = t201 * (((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((d53 * t83_tmp * 80.0 + d53 * t86_tmp * 200.0) + d53 * t91_tmp * 200.0) + d54 * t83_tmp * 200.0) + d54 * t86_tmp * 80.0) + d54 * t91_tmp * 200.0) + d48 * in2[2] * 200.0) + d70 * t86_tmp * 200.0) + d70 * t91_tmp * 80.0) - q_CoefPS_tmp * t83_tmp * 80.0) - q_CoefPS_tmp * t86_tmp * 200.0) - q_CoefPS_tmp * t91_tmp * 200.0) - r_CoefPS_tmp * t83_tmp * 200.0) - r_CoefPS_tmp * t86_tmp * 80.0) - r_CoefPS_tmp * t91_tmp * 200.0) - d61 * in2[2] * 200.0) - v_CoefPS_tmp * t86_tmp * 200.0) - v_CoefPS_tmp * t91_tmp * 80.0) + d109 * t25 * 180.0) + d110 * t23 * 180.0) + d109 * t28 * 180.0) + d111 * t23 * 180.0) + d110 * t28 * 180.0) + d111 * t25 * 180.0) - d112 * t25 * 180.0) - d113 * t23 * 180.0) - d112 * t28 * 180.0) - d114 * t23 * 180.0) - d113 * t28 * 180.0) - d114 * t25 * 180.0) - d56 * t3 * 80.0) - d56 * t4 * 80.0) + d62 * t4 * 40.0) - d58 * t3 * 80.0) + d58 * t4 * 40.0) - d59 * t4 * 80.0) + d63 * t3 * 40.0) - d63 * t4 * 80.0) - d71 * t4 * 80.0) + s_CoefPS_tmp * t3 * 80.0) + s_CoefPS_tmp * t4 * 80.0) - t_CoefPS_tmp * t4 * 40.0) + x_CoefPS_tmp * t3 * 80.0) - x_CoefPS_tmp * t4 * 40.0) + ab_CoefPS_tmp * t4 * 80.0) - u_CoefPS_tmp * t3 * 40.0) + u_CoefPS_tmp * t4 * 80.0) + y_CoefPS_tmp * t4 * 80.0) + d115 * t16 * 60.0) - d116 * t14 * 120.0) - gc_CoefPS_tmp * t16 * 120.0) + d117 * t14 * 60.0) - d118 * t16 * 120.0) - d119 * t14 * 120.0) - d51 * in6[2] * t14 * 120.0) + d115 * t19 * 60.0) - d66 * in6[2] * t14 * 120.0) - gc_CoefPS_tmp * t19 * 120.0) - in1[2] * t2 * in6[2] * t16 * 120.0) + vb_CoefPS_tmp * t14 * 60.0) - d118 * t19 * 120.0) - d116 * t19 * 120.0) - in1[2] * t3 * in6[2] * t16 * 120.0) + d117 * t19 * 60.0) + vb_CoefPS_tmp * t16 * 60.0) - d119 * t19 * 120.0) - wb_CoefPS_tmp * t16 * 60.0) + bc_CoefPS_tmp * t14 * 120.0) + xb_CoefPS_tmp * t16 * 120.0) - dc_CoefPS_tmp * t14 * 60.0) + ac_CoefPS_tmp * t16 * 120.0) + fc_CoefPS_tmp * t14 * 120.0) + yb_CoefPS_tmp * t14 * 120.0) - wb_CoefPS_tmp * t19 * 60.0) + cc_CoefPS_tmp * t14 * 120.0) + xb_CoefPS_tmp * t19 * 120.0) + yb_CoefPS_tmp * t16 * 120.0) - ec_CoefPS_tmp * t14 * 60.0) + d70 * t14 * t25 * 180.0) + d70 * t16 * t23 * 180.0) + ac_CoefPS_tmp * t19 * 120.0) + bc_CoefPS_tmp * t19 * 120.0) + cc_CoefPS_tmp * t16 * 120.0) + d53 * t16 * t28 * 180.0) + d53 * t19 * t25 * 180.0) + d54 * t14 * t28 * 180.0) + d54 * t19 * t23 * 180.0) - dc_CoefPS_tmp * t19 * 60.0) - ec_CoefPS_tmp * t16 * 60.0) + fc_CoefPS_tmp * t19 * 120.0) - v_CoefPS_tmp * t14 * t25 * 180.0) - v_CoefPS_tmp * t16 * t23 * 180.0) - q_CoefPS_tmp * t16 * t28 * 180.0) - q_CoefPS_tmp * t19 * t25 * 180.0) - r_CoefPS_tmp * t14 * t28 * 180.0) - r_CoefPS_tmp * t19 * t23 * 180.0) * -6.0;
}
