        ...
        if ((r.size(0) == D0.size(0)) && (i12 == r1.size(0)) && (D0.size(1) == r1.size(1))) {
            ...
            for (int i14{0}; i14 < d_loop_ub; i14++) {
                ...
                for (int i15{0}; i15 < e_loop_ub; i15++) {
                    r2[i15 + r2.size(0) * i14] =
                        r[i15] * D0[i15 + D0.size(0) * i14] + r1[i15 + r1.size(0) * i14];
                }
            }
            ...
            for (int i16{0}; i16 < f_loop_ub; i16++) {
                ...
                for (int i17{0}; i17 < g_loop_ub; i17++) {
                    r1[i17 + r1.size(0) * i16] = r2[i17 + r2.size(0) * i16];
                }
            }
    ...
    for (int c_i{0}; c_i < 4; c_i++) {
        ...
        if ((r.size(0) == D1.size(0)) && (i22 == r1.size(0)) && (D1.size(1) == r1.size(1))) {
            ...
            for (int i24{0}; i24 < j_loop_ub; i24++) {
                int k_loop_ub;
                k_loop_ub = r1.size(0);
                for (int i25{0}; i25 < k_loop_ub; i25++) {
                    r3[i25 + r3.size(0) * i24] =
                        r[i25] * D1[i25 + D1.size(0) * i24] + r1[i25 + r1.size(0) * i24];
                }
            }
            ...
            for (int i26{0}; i26 < l_loop_ub; i26++) {
                ...
                for (int i27{0}; i27 < m_loop_ub; i27++) {
                    r1[i27 + r1.size(0) * i26] = r3[i27 + r3.size(0) * i26];
                }
            }
        ...
        if ((r.size(0) == D2.size(0)) && (i32 == r1.size(0)) && (D2.size(1) == r1.size(1))) {
            ...
            for (int i34{0}; i34 < p_loop_ub; i34++) {
                ...
                for (int i35{0}; i35 < q_loop_ub; i35++) {
                    r4[i35 + r4.size(0) * i34] =
                        r[i35] * D2[i35 + D2.size(0) * i34] + r1[i35 + r1.size(0) * i34];
                }
            }
            ...
            for (int i36{0}; i36 < r_loop_ub; i36++) {
                ...
                for (int i37{0}; i37 < t_loop_ub; i37++) {
                    r1[i37 + r1.size(0) * i36] = r4[i37 + r4.size(0) * i36];
                }
            }
